...
const financialBenefits = [
  ...
  {
    title: "Protection In NYC & Co-Op Housing",
    description:
      "ESA documentation supports reasonable accommodation requests across NYC rent-stabilized, rent-controlled, co-op, and condo housing units.",
    icon: "/california-benefits-workplaceconsideration.svg",
  },
];
...
const emotionalBenefits = [
  {
    title: "Daily Emotional Grounding",
    description:
      "Having your ESA by your side may make daily activities feel more manageable and less overwhelming.",
    icon: "/whomayqualifies-panicattack.svg",
  },
  {
    title: "Emotional Support During Stress",
    description:
      "Provide emotional comfort and help reduce symptoms of anxiety, depression, trauma, and stress in high-pressure living environments.",
    icon: "/california-benefits-strongersense.svg",
  },
  {
    title: "Encourages Healthy Daily Routines",
    description:
      "Caring for an emotional support animal promotes consistent routines such as walking, feeding, and playtime, which can help provide structure and stability.",
    icon: "/california-benefits-strongersense.svg",
  },
];
...
export function NewYorkBenefitsSection() {
  return (
          ...
          <div className="order-1 lg:order-2 lg:col-span-5 relative flex justify-end items-stretch w-full">
            <div className="sm:hidden relative w-full aspect-[390/513]">
              <Image
                ...
                alt="Benefits of Having an ESA Letter in New York Mobile View"
                fill
                priority
                unoptimized
            ...
            <div className="hidden sm:block lg:hidden relative w-full aspect-[834/1050]">
              <Image
                ...
                alt="Benefits of Having an ESA Letter in New York Tablet View"
                fill
                priority
                unoptimized
                className="object-cover object-top"
            ...
            <div className="hidden lg:block relative w-full h-full lg:min-h-0 flex items-stretch">
              <Image
                ...
                alt="Benefits of Having an ESA Letter in New York"
                fill
                priority
                unoptimized
          ...
          <div className="order-2 lg:order-1 lg:col-span-7 px-4 sm:px-6 lg:px-0 py-2 sm:py-4 lg:py-5 xl:py-12 pr-0 lg:pr-3 xl:pr-4 flex flex-col justify-center">
            <div className="mb-4 lg:mb-5 xl:mb-8">
              <h2 className="font-heading text-2xl sm:text-3xl lg:text-[29px] xl:text-[42px] font-bold text-[#1E3E47] leading-[1.16] tracking-tight mb-2 lg:mb-2.5">
                Benefits of a Clinically Issued
                <br />
              ...
              <p className="font-sans text-xs sm:text-sm lg:text-[12px] xl:text-base text-[#5F6B6F] font-medium leading-relaxed max-w-[520px]">
                Discover how an emotional support animal letter in New York helps individuals with mental health needs navigate housing restrictions while fostering emotional stability.
              </p>
            </div>

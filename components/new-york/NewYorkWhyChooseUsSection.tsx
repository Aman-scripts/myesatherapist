...
const features = [
  ...
  },
  {
    ...
    description:
      "When clinically appropriate, ESA letters are issued in compliance with applicable federal and New York State housing guidelines.",
  },
  {
...
export function NewYorkWhyChooseUsSection() {
  return (

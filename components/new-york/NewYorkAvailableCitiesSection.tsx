...
const newYorkCities = [
  ...
  { name: "Albany", icon: "/losangelesfour.svg" },
  { name: "Long Island", icon: "/losangelesthree.svg" },
  { name: "Syracuse", icon: "/sanfranciscotwo.svg" },
  { name: "Hudson Valley", icon: "/sanfranciscothree.svg" },
  { name: "Yonkers", icon: "/sanfranciscofour.svg" },
];

export function NewYorkAvailableCitiesSection() {
  return (
      ...
      <div className="max-w-[1060px] mx-auto">
        ...
        <div className="text-center max-w-[840px] mx-auto mb-10 sm:mb-12 lg:mb-14">
          ...
          <p className="font-sans text-xs sm:text-sm lg:text-[15px] text-[#5F6B6F] font-medium leading-relaxed mt-3 max-w-[760px] mx-auto">
            From vibrant metropolitan areas like New York City to Buffalo, Rochester, and smaller suburban communities, our secure telehealth platform makes ESA evaluations accessible throughout the Empire State.
          </p>
        </div>

        <div className="grid grid-cols-2 md:grid-cols-4 gap-y-7 sm:gap-y-10 gap-x-3 sm:gap-x-6 lg:gap-x-8 max-w-[960px] mx-auto">
          {newYorkCities.map((city, idx) => (
            <div
              key={idx}

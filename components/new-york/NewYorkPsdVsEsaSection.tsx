...
const esaBullets = [
  "Provide emotional comfort and help reduce symptoms of anxiety, depression, and trauma.",
  "Do not require specialized training; protected under Fair Housing Act (FHA).",
  "Requires a valid recommendation letter from a New York-licensed mental health professional.",
  "Exempt from pet deposits and pet rent fees in approved housing.",
];

const psdBullets = [
  "Individually trained to perform specific tasks supporting psychiatric disabilities.",
  "Trained to ground during panic attacks, interrupt harmful patterns, or remind for medication.",
  "Covered under Americans with Disabilities Act (ADA) with full public access rights.",
];

export function NewYorkPsdVsEsaSection() {
  return (
      ...
      <div className="max-w-[1080px] mx-auto">
        ...
        <div className="text-center max-w-[840px] mx-auto mb-10 sm:mb-12 lg:mb-14">
          <h2 className="font-heading text-2xl sm:text-3xl lg:text-[38px] xl:text-[42px] font-bold text-[#1E3E47] leading-[1.2] tracking-tight">
            ...
            <br className="hidden sm:inline" /> Support Animals in New York
          </h2>
          <p className="font-sans text-xs sm:text-sm lg:text-[15px] text-[#5F6B6F] font-medium leading-relaxed mt-3 max-w-[760px] mx-auto">
            Understanding the distinctions between psychiatric service dogs (PSDs) and emotional support animals (ESAs) in New York helps clarify legal rights, training requirements, and public access protections.
          </p>
        </div>
        ...
        <div className="max-w-[840px] mx-auto bg-[#FCF6E8] rounded-[18px] sm:rounded-[22px] overflow-hidden flex items-stretch shadow-[0_4px_20px_rgba(0,0,0,0.02)]">
          ...
          <div className="p-4 sm:p-5 lg:p-6 flex-1">
            <h3 className="font-heading text-sm sm:text-base lg:text-[17px] font-bold text-[#1E3E47] mb-1.5 leading-snug">
              Psychiatric Service Dog Evaluations in New York
            </h3>
            <p className="font-sans text-[11px] sm:text-xs lg:text-[12.5px] text-[#5F6B6F] font-medium leading-relaxed">
              Training a PSD typically requires 8 to 12 months and may cost $5,000 to $30,000 depending on the program. If you need support starting the process, we can connect you with New-York–licensed mental health providers who can help with PSD evaluations and documentation.
            </p>
          </div>
        </div>

...
const requirements = [
  ...
  "A mental or emotional health condition is identified during the professional clinical evaluation.",
  "The symptoms significantly affect one or more aspects of daily life or functioning in New York.",
  "The clinician evaluates whether an emotional support animal may offer supportive benefits based on the individual's needs.",
  "The individual lives in New York State or plans to relocate to New York.",
];

export function NewYorkRequirementsSection() {
  return (
      ...
      <div className="max-w-[840px] mx-auto">
        <div className="bg-[#F9F5EC] rounded-[24px] sm:rounded-[32px] border border-[#ECE4D5] p-6 sm:p-8 lg:p-10 shadow-sm text-center">
          ...
          <h2 className="font-heading text-xl sm:text-2xl lg:text-[26px] font-bold text-[#1E3E47] text-center mb-6 sm:mb-8 tracking-tight">
            Basic Requirements For New York ESA Letter
          </h2>
          ...
          <div className="max-w-[720px] mx-auto relative overflow-hidden bg-[#FAF7F2] rounded-[14px] py-3.5 px-4 sm:px-6 border border-[#EAE5DC] shadow-xs flex items-center pl-6 sm:pl-7 text-left">
            ...
            <p className="font-sans text-[11.5px] sm:text-xs lg:text-[13px] font-medium text-[#5F6B6F] leading-relaxed">
              ...
              A formal clinical evaluation must be conducted by a mental health professional licensed in New York State to determine whether issuing an ESA letter in New York is clinically appropriate.
            </p>
          </div>

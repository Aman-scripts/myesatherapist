...
const financialBenefits = [
  {
    title: "Fewer Housing Application Rejections",
    description:
      "An ESA letter may reduce housing rejections related to pet restrictions, helping tenants apply to more properties without worrying about strict no-pet rental policies.",
    icon: "/whomayqualifies-california_chronicworry.svg",
  },
  {
    title: "Protection From Certain Pet Policy Charges",
    description:
      "Housing accommodations for emotional support animals can prevent additional pet-related policy charges, helping tenants avoid unexpected costs tied specifically to pet ownership rules.",
    icon: "/california-benefits-workplaceconsideration.svg",
  },
  {
    title: "Easier Lease Negotiations With Landlords",
    description:
      "With proper ESA documentation, tenants may find it easier to negotiate reasonable housing accommodations with landlords, potentially simplifying lease agreements where pets are normally prohibited.",
    icon: "/california-benefits-workplaceconsideration.svg",
  },
];
...
const emotionalBenefits = [
  {
    title: "Encourages Healthy Daily Routines",
    description:
      "Caring for an emotional support animal promotes consistent routines such as walking, feeding, and playtime, which can help provide structure and stability in daily life.",
    icon: "/whomayqualifies-panicattack.svg",
  },
  {
    title: "Emotional Grounding During Overwhelming Moments",
    description:
      "An ESA can provide a calming presence during emotionally intense situations, helping individuals refocus and regain a sense of balance.",
    icon: "/california-benefits-strongersense.svg",
  },
  {
    title: "Increased Sense of Personal Responsibility",
    description:
      "Looking after an emotional support animal may strengthen a sense of purpose and responsibility, which can positively influence motivation and overall emotional well-being.",
    icon: "/california-benefits-strongersense.svg",
  },
];
...
export function WashingtonBenefitsSection() {
  return (
          ...
          <div className="order-1 lg:order-2 lg:col-span-5 relative flex justify-end items-stretch w-full">
            ...
            <div className="sm:hidden relative w-full aspect-[390/513]">
              <Image
                ...
                alt="Benefits of Having an ESA Letter in Washington Mobile View"
                fill
                priority
                unoptimized
            ...
            <div className="hidden sm:block lg:hidden relative w-full aspect-[834/1050]">
              <Image
                ...
                alt="Benefits of Having an ESA Letter in Washington Tablet View"
                fill
                priority
                unoptimized
                className="object-cover object-top"
            ...
            <div className="hidden lg:block relative w-full h-full lg:min-h-0 flex items-stretch">
              <Image
                ...
                alt="Benefits of Having an ESA Letter in Washington"
                fill
                priority
                unoptimized
          ...
          <div className="order-2 lg:order-1 lg:col-span-7 px-4 sm:px-6 lg:px-0 py-2 sm:py-4 lg:py-5 xl:py-12 pr-0 lg:pr-3 xl:pr-4 flex flex-col justify-center">
            ...
            <div className="mb-4 lg:mb-5 xl:mb-8">
              ...
              <p className="font-sans text-xs sm:text-sm lg:text-[12px] xl:text-base text-[#5F6B6F] font-medium leading-relaxed max-w-[520px]">
                Look at the ways in which an emotional support animal letter in Washington can help
                individuals with mental health issues live happier and more confident lives with their ESAs.
              </p>
            </div>

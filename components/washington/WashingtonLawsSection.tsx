...
export function WashingtonLawsSection() {
  return (
      ...
      <div className="max-w-[1060px] mx-auto">
        ...
        <div className="text-center max-w-[820px] mx-auto mb-8 sm:mb-10 lg:mb-12">
          <h2 className="font-heading text-2xl sm:text-3xl lg:text-[36px] xl:text-[40px] font-bold text-[#1E3E47] leading-[1.2] tracking-tight mb-3">
            Housing Accommodations For Emotional Support Animals in Washington
          </h2>
          <p className="font-sans text-xs sm:text-sm lg:text-[14.5px] text-[#5F6B6F] font-medium leading-relaxed max-w-[760px] mx-auto">
            In Washington, ESA housing protections also align with the Washington Law Against Discrimination (RCW 49.60), which works alongside federal Fair Housing Act guidelines to prevent housing discrimination against individuals with qualifying disabilities.
          </p>
        </div>
              ...
              <div className="space-y-4 flex-1">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="font-sans text-[11px] sm:text-[12px] lg:text-[12.5px] text-[#5F6B6F] font-medium leading-relaxed">
                      Housing providers should evaluate ESA accommodation requests individually and fairly, considering supporting documentation before making decisions regarding emotional support animals in rental housing.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="font-sans text-[11px] sm:text-[12px] lg:text-[12.5px] text-[#5F6B6F] font-medium leading-relaxed">
                      Landlords may verify ESA documentation but should not request unnecessary medical details beyond confirming the presence of a qualifying condition and the need for an ESA.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="font-sans text-[11px] sm:text-[12px] lg:text-[12.5px] text-[#5F6B6F] font-medium leading-relaxed">
                      Housing providers are expected to respond to ESA accommodation requests in a timely manner and communicate clearly with tenants during the review process.
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="max-w-[840px] mx-auto bg-[#FCF6E8] rounded-[18px] sm:rounded-[22px] overflow-hidden flex items-stretch shadow-[0_4px_20px_rgba(0,0,0,0.02)]">
          ...
          <div className="p-4 sm:p-5 lg:p-6 flex-1">
            ...
            <p className="font-sans text-[11px] sm:text-xs lg:text-[12.5px] text-[#5F6B6F] font-medium leading-relaxed">
              Under the Fair Housing Act, emotional support animals may be allowed in housing in Washington with proper documentation. However, the Americans with Disabilities Act generally does not grant ESAs public access rights like service animals. Many airlines also treat ESAs as pets and are not required to recognize them under the Air Carrier Access Act.
            </p>
          </div>
        </div>

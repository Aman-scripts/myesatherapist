...
const conditions = [
  {
    ...
    description: "Persistent worry and nervous tension affecting daily activities.",
    icon: "/whomayqualifies-california_chronicworry.svg",
  },
  {
    title: "Major Depressive Disorder",
    description: "Ongoing sadness, low energy, and loss of interest in routine activities.",
    icon: "/whomayqualifies-panicattack.svg",
  },
  {
    title: "Post-Traumatic Stress Disorder",
    description: "Trauma-induced anxiety, intrusive thoughts, and emotional distress.",
    icon: "/whomayqualifies-california_posttrauma.svg",
  },
  {
    title: "Bipolar & Mood Disorders",
    description: "Fluctuating emotional states that interfere with personal well-being.",
    icon: "/whomayqualifies-moodconditions.svg",
  },
];

export function KentuckyWhoQualifiesSection() {
  return (
          ...
          <div className="order-1 lg:order-2 lg:col-span-5 relative flex justify-end items-center w-full">
            ...
            <div className="sm:hidden relative w-full aspect-[390/440]">
              <Image
                ...
                alt="Who May Qualify for an ESA Letter in Kentucky Mobile View"
                fill
                priority
                unoptimized
            ...
            <div className="hidden sm:block lg:hidden relative w-full aspect-[834/943]">
              <Image
                ...
                alt="Who May Qualify for an ESA Letter in Kentucky Tablet View"
                fill
                priority
                unoptimized
                className="object-cover object-top"
            ...
            <div className="hidden lg:flex items-center justify-end w-full h-full">
              <div className="relative w-full max-h-[620px] aspect-[694/827] ml-auto">
                <Image
                  ...
                  alt="Who qualifies for Kentucky ESA Letter"
                  fill
                  priority
                  unoptimized
          ...
          <div className="order-2 lg:order-1 lg:col-span-7 px-4 sm:px-6 lg:px-0 py-2 sm:py-4 lg:py-6 pr-0 lg:pr-2 xl:pr-4 flex flex-col justify-center">
            ...
            <div className="mb-4 lg:mb-4">
              <h2 className="font-heading text-2xl sm:text-3xl lg:text-[32px] xl:text-[42px] font-bold text-[#1E3E47] leading-[1.16] tracking-tight mb-2">
                Who May Be Eligible for an
                <br />
                ESA Letter Kentucky?
              </h2>
              <p className="font-sans text-xs sm:text-sm lg:text-[13px] xl:text-base text-[#5F6B6F] font-medium leading-[1.5] max-w-[540px]">
                Kentucky residents who experience mental health challenges that affect daily activities may seek an evaluation from a licensed mental health professional. A clinical assessment helps determine if an emotional support animal could provide therapeutic relief. Common conditions evaluated by Kentucky clinicians include:
              </p>
            </div>

...
const financialBenefits = [
  {
    ...
    description:
      "Kentucky residents may request reasonable accommodations to live with an ESA, even in properties enforcing strict no-pet policies.",
    icon: "/whomayqualifies-california_chronicworry.svg",
  },
  {
    title: "No Extra Pet Rent or Fees",
    description:
      "Kentucky landlords cannot charge pet rent, pet deposits, or application fees once legitimate ESA documentation is validated.",
...
const emotionalBenefits = [
  {
    title: "Relieves Anxiety & Everyday Stress",
    description:
      "Having an ESA provides comfort and companionship, easing anxiety symptoms and offering peace of mind in Kentucky homes.",
    icon: "/whomayqualifies-panicattack.svg",
  },
  {
    title: "Promotes Emotional Stability",
    description:
      "Consistent presence from an ESA offers grounding during emotional distress, panic attacks, or mood shifts.",
    icon: "/california-benefits-strongersense.svg",
  },
  {
    title: "Builds Healthy Daily Routines",
    description:
      "Daily pet care fosters structure, physical movement, and an improved overall quality of life and well-being.",
    icon: "/california-benefits-strongersense.svg",
  },
];
...
export function KentuckyBenefitsSection() {
  return (
          ...
          <div className="order-1 lg:order-2 lg:col-span-5 relative flex justify-end items-stretch w-full">
            ...
            <div className="sm:hidden relative w-full aspect-[390/513]">
              <Image
                ...
                alt="Benefits of Having an ESA Letter in Kentucky Mobile View"
                fill
                priority
                unoptimized
            ...
            <div className="hidden sm:block lg:hidden relative w-full aspect-[834/1050]">
              <Image
                ...
                alt="Benefits of Having an ESA Letter in Kentucky Tablet View"
                fill
                priority
                unoptimized
                className="object-cover object-top"
            ...
            <div className="hidden lg:block relative w-full h-full lg:min-h-0 flex items-stretch">
              <Image
                ...
                alt="Benefits of Having an ESA Letter in Kentucky"
                fill
                priority
                unoptimized
          ...
          <div className="order-2 lg:order-1 lg:col-span-7 px-4 sm:px-6 lg:px-0 py-2 sm:py-4 lg:py-5 xl:py-12 pr-0 lg:pr-3 xl:pr-4 flex flex-col justify-center">
            ...
            <div className="mb-4 lg:mb-5 xl:mb-8">
              ...
              <p className="font-sans text-xs sm:text-sm lg:text-[12px] xl:text-base text-[#5F6B6F] font-medium leading-relaxed max-w-[520px]">
                Understand how a legally valid ESA letter in Kentucky confirms your therapeutic need for support, creates a smoother housing experience, and protects your rights under state and federal law.
              </p>
            </div>

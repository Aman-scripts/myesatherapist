...
const conditions = [
  {
    ...
    description: "Trauma-related symptoms like hypervigilance and flashbacks affecting routine.",
    icon: "/whomayqualifies-california_chronicworry.svg",
  },
  {
    title: "Major Depressive Disorder",
    description: "Persistent low mood and loss of motivation, disrupting daily functioning.",
    icon: "/whomayqualifies-panicattack.svg",
  },
  {
    title: "Generalized Anxiety Disorder",
    description: "Excessive worries and tension minimizing the ability to function daily.",
    icon: "/whomayqualifies-california_posttrauma.svg",
  },
  {
    title: "Panic Disorder",
    description: "Recurrent panic attacks and constant worries of future attacks.",
    icon: "/whomayqualifies-moodconditions.svg",
  }
];

export function MississippiWhoQualifiesSection() {
  return (
          ...
          <div className="order-1 lg:order-2 lg:col-span-5 relative flex justify-end items-center w-full">
            <div className="sm:hidden relative w-full aspect-[390/440]">
              <Image
                ...
                alt="Who May Qualify for an ESA Letter in Mississippi Mobile View"
                fill
                priority
                unoptimized
            ...
            <div className="hidden sm:block lg:hidden relative w-full aspect-[834/943]">
              <Image
                ...
                alt="Who May Qualify for an ESA Letter in Mississippi Tablet View"
                fill
                priority
                unoptimized
                className="object-cover object-top"
            ...
            <div className="hidden lg:flex items-center justify-end w-full h-full">
              <div className="relative w-full max-h-[620px] aspect-[694/827] ml-auto">
                <Image
                  ...
                  alt="Who qualifies for Mississippi ESA Letter"
                  fill
                  priority
                  unoptimized

...
const stateCities = [
  ...
  { name: "Biloxi", icon: "/losangelestwo.svg" },
  { name: "Southaven", icon: "/losangelesfour.svg" },
  { name: "Hattiesburg", icon: "/losangelesthree.svg" },
  { name: "Oxford", icon: "/sanfranciscotwo.svg" },
  { name: "Tupelo", icon: "/sanfranciscothree.svg" },
  { name: "Meridian", icon: "/sanfranciscofour.svg" }
];

export function MississippiAvailableCitiesSection() {
  return (
      ...
      <div className="max-w-[1060px] mx-auto">
        ...
        <div className="text-center max-w-[840px] mx-auto mb-10 sm:mb-12 lg:mb-14">
          <h2 className="font-heading text-2xl sm:text-3xl lg:text-[40px] xl:text-[44px] font-bold text-[#1E3E47] leading-[1.2] tracking-tight">
            Available Everywhere in Mississippi
          </h2>
          <p className="font-sans text-xs sm:text-sm lg:text-[15px] text-[#5F6B6F] font-medium leading-relaxed mt-3 max-w-[760px] mx-auto">
            Our entire process runs through secure telehealth, which means we're available to clients across all cities and counties in Mississippi, from Jackson and Gulfport to Biloxi, Southaven, and Oxford.
          </p>
        </div>

...
export function MississippiPsdVsEsaSection() {
  return (
      ...
      <div className="max-w-[1080px] mx-auto">
        ...
        <div className="text-center max-w-[840px] mx-auto mb-10 sm:mb-12 lg:mb-14">
          ...
          <p className="font-sans text-xs sm:text-sm lg:text-[15px] text-[#5F6B6F] font-medium leading-relaxed mt-3 max-w-[760px] mx-auto">
            It is critical to understand the distinctions between psychiatric service dogs (PSDs) and emotional support animals (ESAs) in Mississippi. While both help people with mental health issues, their training requirements and legal protections differ.
          </p>
        </div>

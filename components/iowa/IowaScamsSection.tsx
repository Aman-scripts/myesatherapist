...
export function IowaScamsSection() {
  return (
      ...
      <div className="max-w-[1060px] mx-auto">
        ...
        <div className="text-center max-w-[840px] mx-auto mb-8 sm:mb-10 lg:mb-12">
          <h2 className="font-heading text-2xl sm:text-3xl lg:text-[40px] xl:text-[44px] font-bold text-[#1E3E47] leading-[1.2] tracking-tight">
            ESA Letter Iowa : Facts and Common Misconceptions
          </h2>
          <p className="font-sans text-xs sm:text-sm lg:text-[15px] text-[#5F6B6F] font-medium leading-relaxed mt-3 max-w-[760px] mx-auto">
            Understanding the actual guidelines for emotional support animals in Iowa can help to eliminate common misconceptions. Learning how ESA documentation works promotes responsible requests and ensures that they are consistent with professional evaluations and housing accommodation standards.
          </p>
        </div>
          ...
          <div className="p-4 sm:p-5 lg:p-6 flex items-center gap-3.5 sm:gap-4 flex-1">
            ...
            <div className="flex-1">
              ...
              <p className="font-sans text-xs sm:text-[13px] lg:text-[13.5px] text-[#5F6B6F] font-medium leading-relaxed">
                There is no official ESA registry, ID, or certification maintained by any government agency in Iowa or the United States. Only a licensed mental health professional can issue a valid ESA letter.
              </p>
            </div>
          </div>
        </div>
              ...
              <div className="space-y-4 sm:space-y-4.5 flex-1">
                ...
                <div className="flex items-start gap-3.5">
                  ...
                  <h4 className="font-sans text-xs sm:text-[13.5px] lg:text-[14px] font-bold text-[#D9383A] pt-0.5 leading-snug">
                    Claim there is an &ldquo;official ESA registry&rdquo; in Iowa.
                  </h4>
                </div>
                ...
                <div className="flex items-start gap-3.5">
                  ...
                  <h4 className="font-sans text-xs sm:text-[13.5px] lg:text-[14px] font-bold text-[#D9383A] pt-0.5 leading-snug">
                    Do not involve a licensed Iowa mental health professional.
                  </h4>
                </div>

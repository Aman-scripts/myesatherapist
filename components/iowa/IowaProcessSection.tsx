...
const steps = [
  {
    ...
    description:
      "Select a convenient time to connect with an Iowa-licensed mental health professional.",
  ...
  },
  {
    ...
    description:
      "During a secure phone or video session, the clinician reviews your mental health history and symptoms to determine ESA suitability, following Iowa's 30-day therapeutic relationship requirement.",
  ...
  },
  {
    ...
    description:
      "After the evaluation, the clinician makes an objective, independent decision based on clinical standards. If the ESA recommendation is considered appropriate, the letter is finalized and delivered electronically.",
...
export function IowaProcessSection() {
  const scrollToForm = () => {

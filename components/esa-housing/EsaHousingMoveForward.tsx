...
export function EsaHousingMoveForward() {
  return (
    <section className="relative w-full overflow-hidden" style={{ backgroundImage: TEAL_GRADIENT }}>
      <div className="hidden md:block absolute right-0 bottom-0 h-full aspect-[254/262] pointer-events-none">
        <Image
      ...
      <div className="relative z-10 max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8 py-14 sm:py-16 flex flex-col items-center gap-6 text-center">
        <h2 className="font-heading text-3xl sm:text-4xl xl:text-[44px] font-bold text-[#FAF7F2] leading-[1.2] xl:leading-[54px] tracking-[-0.00015em] max-w-[888px]">
          Move Forward With Clarity About Your Housing Options
        </h2>
        <p className="font-sans text-base sm:text-[18px] font-semibold leading-[30px] text-[#FAF7F2] max-w-[932px]">

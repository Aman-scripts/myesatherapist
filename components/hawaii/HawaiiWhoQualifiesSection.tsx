...
const conditions = [
  {
    title: "Dysthymia",
    description: "Persistent low-grade depression affecting daily energy.",
    icon: "/whomayqualifies-california_chronicworry.svg",
  },
  {
    title: "Cyclothymic Disorder",
    description: "Frequent mild mood swings impacting emotional balance.",
    icon: "/whomayqualifies-panicattack.svg",
  },
  {
    title: "Social Communication Disorder",
    description: "Difficulty with social interaction and communication.",
    icon: "/whomayqualifies-california_posttrauma.svg",
  },
  {
    title: "Adjustment Disorder with Anxiety",
    description: "Heightened stress reactions to significant life changes.",
    icon: "/whomayqualifies-moodconditions.svg",
  },
];

export function HawaiiWhoQualifiesSection() {
  return (
          ...
          <div className="order-1 lg:order-2 lg:col-span-5 relative flex justify-end items-center w-full">
            ...
            <div className="sm:hidden relative w-full aspect-[390/440]">
              <Image
                ...
                alt="Who May Qualify for an ESA Letter in Hawaii Mobile View"
                fill
                priority
                unoptimized
            ...
            <div className="hidden sm:block lg:hidden relative w-full aspect-[834/943]">
              <Image
                ...
                alt="Who May Qualify for an ESA Letter in Hawaii Tablet View"
                fill
                priority
                unoptimized
                className="object-cover object-top"
            ...
            <div className="hidden lg:flex items-center justify-end w-full h-full">
              <div className="relative w-full max-h-[620px] aspect-[694/827] ml-auto">
                <Image
                  ...
                  alt="Who qualifies for Hawaii ESA Letter"
                  fill
                  priority
                  unoptimized

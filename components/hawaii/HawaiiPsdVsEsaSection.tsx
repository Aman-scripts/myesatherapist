...
const esaBullets = [
  "Provide companionship and emotional comfort to individuals with mental health conditions.",
  "Do not require specialized task training; valid ESA letter needed for housing.",
...
const psdBullets = [
  "Specially trained to perform specific tasks for psychiatric disabilities.",
  "Recognized under the Americans with Disabilities Act of 1990.",
  "Allowed public access in restaurants, stores, workplaces, and public places.",
];

export function HawaiiPsdVsEsaSection() {
  return (
      ...
      <div className="max-w-[1080px] mx-auto">
        ...
        <div className="text-center max-w-[840px] mx-auto mb-10 sm:mb-12 lg:mb-14">
          <h2 className="font-heading text-2xl sm:text-3xl lg:text-[38px] xl:text-[42px] font-bold text-[#1E3E47] leading-[1.2] tracking-tight">
            ...
            <br className="hidden sm:inline" /> Support Animals in Hawaii
          </h2>
          <p className="font-sans text-xs sm:text-sm lg:text-[15px] text-[#5F6B6F] font-medium leading-relaxed mt-3 max-w-[760px] mx-auto">
            In Hawaii, it&apos;s important to understand the difference between psychiatric service dogs (PSDs) and emotional support animals (ESAs). While both assist individuals with mental health conditions, they differ in roles, legal recognition, and training requirements.
          </p>
        </div>

...
const features = [
  {
    ...
    description:
      "Evaluations are conducted by independent U.S.-licensed mental health professionals authorized to assess ESA eligibility in Hawaii.",
  },
  {
  ...
  },
  {
    ...
    description:
      "When clinically appropriate, ESA letters are issued in compliance with applicable federal and Hawaii state housing guidelines.",
  },
  {
    icon: "/whychoose-section-nationwide-access.svg",
    title: "Statewide & Island-wide Access",
    description:
      "Telehealth evaluations available for individuals across all Hawaiian islands, subject to clinician availability.",
  },
  {
...
export function HawaiiWhyChooseUsSection() {
  return (

...
const indianaCities = [
  ...
  { name: "Carmel / Fishers", icon: "/sanfranciscotwo.svg" },
  { name: "Lafayette", icon: "/sanfranciscothree.svg" },
  { name: "All Other Cities", icon: "/sanfranciscofour.svg" },
];

export function IndianaAvailableCitiesSection() {
  return (
      ...
      <div className="max-w-[1060px] mx-auto">
        ...
        <div className="text-center max-w-[840px] mx-auto mb-10 sm:mb-12 lg:mb-14">
          ...
          <p className="font-sans text-xs sm:text-sm lg:text-[15px] text-[#5F6B6F] font-medium leading-relaxed mt-3 max-w-[760px] mx-auto">
            Across Indiana, rental policies can differ widely from property to property. Our secure telehealth platform helps residents access licensed mental health professionals for ESA evaluations no matter where they live in the state.
          </p>
        </div>

        <div className="grid grid-cols-2 md:grid-cols-4 gap-y-7 sm:gap-y-10 gap-x-3 sm:gap-x-6 lg:gap-x-8 max-w-[960px] mx-auto">
          {indianaCities.map((city, idx) => (
            <div
              key={idx}

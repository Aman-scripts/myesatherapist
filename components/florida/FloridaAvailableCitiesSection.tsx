...
const floridaCities = [
  ...
  { name: "Sarasota", icon: "/sanfranciscofour.svg" },
];

export function FloridaAvailableCitiesSection() {
  return (
      ...
      <div className="max-w-[1060px] mx-auto">
        ...
        <div className="text-center max-w-[840px] mx-auto mb-10 sm:mb-12 lg:mb-14">
          ...
          <p className="font-sans text-xs sm:text-sm lg:text-[15px] text-[#5F6B6F] font-medium leading-relaxed mt-3 max-w-[760px] mx-auto">
            From South Florida&apos;s competitive rental markets to communities across the Panhandle, our secure telehealth platform helps Florida residents access ESA evaluations anywhere in the Sunshine State.
          </p>
        </div>

...
const features = [
  {
    ...
    description:
      "Evaluations are conducted by independent U.S.-licensed health care practitioners authorized to assess ESA eligibility in Florida.",
  },
  {
  ...
  },
  {
    ...
    description:
      "When clinically appropriate, ESA letters are issued in compliance with federal FHA guidelines and Florida Statutes section 760.27.",
  },
  {
    icon: "/whychoose-section-nationwide-access.svg",
    title: "Nationwide Access",
    description:
      "Telehealth evaluations available for individuals across Florida, subject to clinician availability.",
  },
  {
...
export function FloridaWhyChooseUsSection() {
  return (

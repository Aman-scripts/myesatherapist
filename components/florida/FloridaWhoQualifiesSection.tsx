...
const conditions = [
  {
    ...
    description: "Persistent stress affecting emotional stability.",
    icon: "/whomayqualifies-california_chronicworry.svg",
  },
  {
    title: "Panic Attacks & Agoraphobia",
    description: "Sudden overwhelming fear in public or home spaces.",
    icon: "/whomayqualifies-panicattack.svg",
  },
  {
    title: "Post-Traumatic Stress (PTSD)",
    description: "Emotional distress following traumatic events.",
    icon: "/whomayqualifies-california_posttrauma.svg",
  },
  {
    title: "Depression & Mood Disorders",
    description: "Ongoing sadness or loss of motivation in daily life.",
    icon: "/whomayqualifies-moodconditions.svg",
  },
];

export function FloridaWhoQualifiesSection() {
  return (
          ...
          <div className="order-1 lg:order-2 lg:col-span-5 relative flex justify-end items-stretch w-full">
            <div className="sm:hidden relative w-full aspect-[390/440]">
              <Image
                ...
                alt="Who May Qualify for an ESA Letter in Florida Mobile View"
                fill
                priority
                unoptimized
            ...
            <div className="hidden sm:block lg:hidden relative w-full aspect-[834/943]">
              <Image
                ...
                alt="Who May Qualify for an ESA Letter in Florida Tablet View"
                fill
                priority
                unoptimized
                className="object-cover object-top"
            ...
            <div className="hidden lg:block relative w-full h-full min-h-[360px]">
              <Image
                ...
                alt="Who qualifies for Florida ESA Letter"
                fill
                priority
                unoptimized
          ...
          <div className="order-2 lg:order-1 lg:col-span-7 px-4 sm:px-6 lg:px-0 py-2 sm:py-4 lg:py-6 pr-0 lg:pr-2 xl:pr-4 flex flex-col justify-center">
            <div className="mb-4 lg:mb-4">
              <h2 className="font-heading text-2xl sm:text-3xl lg:text-[32px] xl:text-[42px] font-bold text-[#1E3E47] leading-[1.16] tracking-tight mb-2">
                Who Qualifies For an Emotional
                <br />
                Support Animal Letter in Florida?
              </h2>
              <p className="font-sans text-xs sm:text-sm lg:text-[13px] xl:text-base text-[#5F6B6F] font-medium leading-[1.5] max-w-[540px]">
                All consultations are conducted through secure, HIPAA-compliant telehealth platforms. During the evaluation, a licensed practitioner determines whether an emotional support animal is clinically appropriate for your mental or emotional health condition. All determinations are based on clinical judgment:
              </p>
            </div>

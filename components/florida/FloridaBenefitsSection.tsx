...
const financialBenefits = [
  {
    title: "No Pet Deposits or Pet Rent Fees",
    description:
      "When an ESA is approved as a reasonable accommodation in Florida, housing providers generally cannot charge pet deposits, pet rent, or pet policy fees.",
    icon: "/whomayqualifies-california_chronicworry.svg",
  },
  {
    title: "No Breed or Weight Exclusions",
    description:
      "Housing providers in Florida cannot deny housing solely because of an emotional support animal's size, weight, or breed.",
    icon: "/california-benefits-workplaceconsideration.svg",
  },
  {
    title: "Full FHA & FL Statute 760.27 Protection",
    description:
      "Valid ESA letters provide accommodation rights across Florida rental apartments, HOAs, condos, and leased properties.",
    icon: "/california-benefits-workplaceconsideration.svg",
  },
];
...
const emotionalBenefits = [
  {
    ...
    description:
      "Emotional support animals offer constant companionship, helping reduce symptoms of anxiety, depression, and trauma.",
    icon: "/whomayqualifies-panicattack.svg",
  },
  {
    title: "Calming Companion Presence",
    description:
      "An ESA provides a soothing presence during emotionally intense moments, helping individuals regain focus and emotional grounding.",
    icon: "/california-benefits-strongersense.svg",
  },
  {
    title: "Encourages Healthy Daily Structure",
    description:
      "Caring for an ESA promotes consistent routines like walking and feeding, fostering purpose and motivation in daily living.",
    icon: "/california-benefits-strongersense.svg",
  },
];
...
export function FloridaBenefitsSection() {
  return (
          ...
          <div className="order-1 lg:order-2 lg:col-span-5 relative flex justify-end items-stretch w-full">
            <div className="sm:hidden relative w-full aspect-[390/513]">
              <Image
                ...
                alt="Benefits of Having an ESA Letter in Florida Mobile View"
                fill
                priority
                unoptimized
            ...
            <div className="hidden sm:block lg:hidden relative w-full aspect-[834/1050]">
              <Image
                ...
                alt="Benefits of Having an ESA Letter in Florida Tablet View"
                fill
                priority
                unoptimized
                className="object-cover object-top"
            ...
            <div className="hidden lg:block relative w-full h-full lg:min-h-0 flex items-stretch">
              <Image
                ...
                alt="Benefits of Having an ESA Letter in Florida"
                fill
                priority
                unoptimized
          ...
          <div className="order-2 lg:order-1 lg:col-span-7 px-4 sm:px-6 lg:px-0 py-2 sm:py-4 lg:py-5 xl:py-12 pr-0 lg:pr-3 xl:pr-4 flex flex-col justify-center">
            <div className="mb-4 lg:mb-5 xl:mb-8">
              ...
              <p className="font-sans text-xs sm:text-sm lg:text-[12px] xl:text-base text-[#5F6B6F] font-medium leading-relaxed max-w-[520px]">
                Discover how an emotional support animal letter in Florida protects your housing rights under Florida Statute 760.27 while providing valuable mental health benefits.
              </p>
            </div>

...
const steps = [
  {
    ...
    description:
      "Choose a convenient time to speak with a licensed health care practitioner authorized to practice in Florida.",
  ...
  },
  {
    ...
    description:
      "Join a confidential session via secure phone or video call. During the consultation, the practitioner will assess your mental health history and current emotional concerns to determine whether an emotional support animal would be beneficial.",
  ...
  },
  {
    ...
    description:
      "Following the evaluation, the licensed practitioner renders an independent decision. If appropriate, your ESA letter will be delivered to you via secure email in compliance with FL Statute 760.27.",
...
const differentiators = [
  ...
  "Evaluations conducted by licensed health care practitioners in Florida.",
...
export function FloridaProcessSection() {
  const scrollToForm = () => {
    ...
    >
      <div className="max-w-[1260px] mx-auto">
        ...
        <div className="text-center max-w-[1050px] mx-auto mb-14 sm:mb-16">
          <h2 className="font-heading text-2xl sm:text-3xl lg:text-[40px] xl:text-[44px] font-bold text-[#1E3E47] leading-[1.18] tracking-tight mb-4 md:whitespace-nowrap"> How ESA Letter Process Works in Florida? </h2>
          <p className="font-sans text-sm sm:text-base lg:text-[16.5px] text-[#5F6B6F] font-medium leading-[1.65]">
            We connect Florida residents with licensed health care practitioners for personalized emotional wellness assessments.
          </p>
        </div>
            ...
            >
              <div>
                ...
                <div className="flex items-center justify-between mb-6">
                  <div className="w-13 h-13 rounded-full bg-[#184F59] flex items-center justify-center shrink-0 shadow-sm p-3">
                    <Image
                      src={step.icon}
                      alt={step.title}
                      width={26}
        ...
        {/* Why Florida Residents Choose Our ESA Letter Process? Container */}
        <div className="bg-[#FAF5EB] rounded-[32px] sm:rounded-[36px] border border-[#EFE8DC] p-8 sm:p-10 lg:p-12 max-w-[920px] mx-auto shadow-xs">
          <h3 className="font-heading text-xl sm:text-2xl lg:text-[28px] xl:text-3xl font-bold text-[#1E3E47] text-center mb-8 md:whitespace-nowrap">
            Why Florida Residents Choose Our ESA Letter Process?
          </h3>

...
const financialBenefits = [
  {
    title: "Avoid Housing Application Denials",
    description:
      "An ESA letter allows Michigan residents with mental health conditions to apply for housing without worrying about strict no-pet rules.",
    icon: "/whomayqualifies-california_chronicworry.svg",
  },
  {
    title: "Exemption from Pet Fees & Deposits",
    description:
      "Under the Fair Housing Act, landlords cannot charge extra pet deposits, monthly pet rent, or application fees for verified emotional support animals.",
    icon: "/california-benefits-workplaceconsideration.svg",
  },
  {
    title: "Easier Lease Agreement Negotiations",
    description:
      "Having legitimate documentation simplifies discussions with property managers and helps secure reasonable housing accommodations.",
    icon: "/california-benefits-workplaceconsideration.svg",
  },
];
...
const emotionalBenefits = [
  {
    title: "Constant Emotional Comfort",
    description:
      "ESAs provide calming companionship that helps ease symptoms of chronic anxiety, depression, and stress.",
    icon: "/whomayqualifies-panicattack.svg",
  },
  {
    title: "Promotes Healthy Daily Routines",
    description:
      "Caring for an ESA encourages regular habits like walking, feeding, and active play, providing structure and daily motivation.",
    icon: "/california-benefits-strongersense.svg",
  },
  {
    title: "Reduces Social Isolation",
    description:
      "The presence of an emotional support animal offers unconditional support, lessening feelings of loneliness and emotional distress.",
    icon: "/california-benefits-strongersense.svg",
  },
];
...
export function MichiganBenefitsSection() {
  return (
          ...
          <div className="order-1 lg:order-2 lg:col-span-5 relative flex justify-end items-stretch w-full">
            ...
            <div className="sm:hidden relative w-full aspect-[390/513]">
              <Image
                ...
                alt="Benefits of Having an ESA Letter in Michigan Mobile View"
                fill
                priority
                unoptimized
            ...
            <div className="hidden sm:block lg:hidden relative w-full aspect-[834/1050]">
              <Image
                ...
                alt="Benefits of Having an ESA Letter in Michigan Tablet View"
                fill
                priority
                unoptimized
                className="object-cover object-top"
            ...
            <div className="hidden lg:block relative w-full h-full lg:min-h-0 flex items-stretch">
              <Image
                ...
                alt="Benefits of Having an ESA Letter in Michigan"
                fill
                priority
                unoptimized
          ...
          <div className="order-2 lg:order-1 lg:col-span-7 px-4 sm:px-6 lg:px-0 py-2 sm:py-4 lg:py-5 xl:py-12 pr-0 lg:pr-3 xl:pr-4 flex flex-col justify-center">
            <div className="mb-4 lg:mb-5 xl:mb-8">
              ...
              <p className="font-sans text-xs sm:text-sm lg:text-[12px] xl:text-base text-[#5F6B6F] font-medium leading-relaxed max-w-[520px]">
                Discover how a legitimate emotional support animal letter in Michigan provides financial protections and emotional support for daily life.
              </p>
            </div>

...
export function MichiganLawsSection() {
  return (
      ...
      <div className="max-w-[1060px] mx-auto">
        <div className="text-center max-w-[820px] mx-auto mb-8 sm:mb-10 lg:mb-12">
          <h2 className="font-heading text-2xl sm:text-3xl lg:text-[36px] xl:text-[40px] font-bold text-[#1E3E47] leading-[1.2] tracking-tight mb-3">
            Housing Accommodations For Emotional Support Animals in Michigan
          </h2>
          <p className="font-sans text-xs sm:text-sm lg:text-[14.5px] text-[#5F6B6F] font-medium leading-relaxed max-w-[760px] mx-auto">
            In Michigan, ESA housing protections align with the Persons with Disabilities Civil Rights Act and the federal Fair Housing Act to ensure fair housing accommodations for qualifying individuals.
          </p>
        </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="font-sans text-[11px] sm:text-[12px] lg:text-[12.5px] text-[#5F6B6F] font-medium leading-relaxed">
                      Under the Fair Housing Act, housing providers must review ESA accommodation requests and allow residents with valid documentation to live with their emotional support animals.
                    </p>
                  </div>
                </div>
        ...
        <div className="max-w-[840px] mx-auto bg-[#FCF6E8] rounded-[18px] sm:rounded-[22px] overflow-hidden flex items-stretch shadow-[0_4px_20px_rgba(0,0,0,0.02)]">
          ...
          <div className="p-4 sm:p-5 lg:p-6 flex-1">
            ...
            <p className="font-sans text-[11px] sm:text-xs lg:text-[12.5px] text-[#5F6B6F] font-medium leading-relaxed">
              Under the Fair Housing Act, emotional support animals are allowed in housing in Michigan with valid documentation. However, ESAs do not have automatic public access rights under the Americans with Disabilities Act. Airline travel rules vary and ESAs are subject to individual carrier guidelines.
            </p>
          </div>
        </div>
      </div>

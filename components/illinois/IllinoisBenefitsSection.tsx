...
const financialBenefits = [
  {
    ...
    description:
      "Under the Fair Housing Act, individuals with a qualifying need may request reasonable accommodation for an emotional support pet, even in housing with a no-pet policy.",
    icon: "/whomayqualifies-california_chronicworry.svg",
  },
  {
    title: "Pet Fees and Deposits",
    description:
      "With valid ESA documentation, standard pet fees or deposits may be waived. Tenants remain responsible for any damage caused by their animal.",
    icon: "/california-benefits-workplaceconsideration.svg",
  },
  {
    title: "No Breed or Size Limitations",
    description:
      "Housing providers cannot deny an ESA solely based on breed or size, unless the animal poses a direct safety threat.",
    icon: "/california-benefits-workplaceconsideration.svg",
  },
];
...
const emotionalBenefits = [
  {
    ...
    description:
      "For some individuals, an emotional support animal may help provide comfort, companionship, and emotional reassurance.",
    icon: "/whomayqualifies-panicattack.svg",
  },
  {
    title: "Stress Relief",
    description:
      "An ESA may help promote a sense of calm and relief from daily stressors, offering emotional grounding.",
    icon: "/california-benefits-strongersense.svg",
  },
  {
    title: "Improves Daily Routine",
    description:
      "Having an animal can help introduce structure into daily life through regular activities such as walks, feeding, and care.",
    icon: "/california-benefits-strongersense.svg",
  },
];
...
export function IllinoisBenefitsSection() {
  return (
          ...
          <div className="order-1 lg:order-2 lg:col-span-5 relative flex justify-end items-stretch w-full">
            ...
            <div className="sm:hidden relative w-full aspect-[390/513]">
              <Image
                ...
                alt="Benefits Of Clinically Approved ESA Letter in Illinois Mobile View"
                fill
                priority
                unoptimized
            ...
            <div className="hidden sm:block lg:hidden relative w-full aspect-[834/1050]">
              <Image
                ...
                alt="Benefits Of Clinically Approved ESA Letter in Illinois Tablet View"
                fill
                priority
                unoptimized
                className="object-cover object-top"
            ...
            <div className="hidden lg:block relative w-full h-full lg:min-h-0 flex items-stretch">
              <Image
                ...
                alt="Benefits Of Clinically Approved ESA Letter in Illinois"
                fill
                priority
                unoptimized
          ...
          <div className="order-2 lg:order-1 lg:col-span-7 px-4 sm:px-6 lg:px-0 py-2 sm:py-4 lg:py-5 xl:py-12 pr-0 lg:pr-3 xl:pr-4 flex flex-col justify-center">
            ...
            <div className="mb-4 lg:mb-5 xl:mb-8">
              <h2 className="font-heading text-2xl sm:text-3xl lg:text-[29px] xl:text-[42px] font-bold text-[#1E3E47] leading-[1.16] tracking-tight mb-2 lg:mb-2.5">
                Benefits Of Clinically Approved ESA Letter in Illinois
              </h2>
              <p className="font-sans text-xs sm:text-sm lg:text-[12px] xl:text-base text-[#5F6B6F] font-medium leading-relaxed max-w-[520px]">
                A valid ESA recommendation issued by a licensed Illinois mental health professional may help support housing-related accommodation requests under federal fair housing guidelines.
              </p>
            </div>

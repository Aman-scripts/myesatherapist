...
const illinoisCities = [
  ...
  { name: "Naperville", icon: "/losangelestwo.svg" },
  { name: "Rockford", icon: "/losangelesfour.svg" },
  { name: "Joliet", icon: "/losangelesthree.svg" },
  { name: "Springfield", icon: "/sanfranciscotwo.svg" },
  { name: "Peoria", icon: "/sanfranciscothree.svg" },
  { name: "All Other Cities", icon: "/sanfranciscofour.svg" },
];

export function IllinoisAvailableCitiesSection() {
  return (
      ...
      <div className="max-w-[1060px] mx-auto">
        ...
        <div className="text-center max-w-[840px] mx-auto mb-10 sm:mb-12 lg:mb-14">
          ...
          <p className="font-sans text-xs sm:text-sm lg:text-[15px] text-[#5F6B6F] font-medium leading-relaxed mt-3 max-w-[760px] mx-auto">
            Our secure telehealth network connects residents across Illinois with licensed mental health professionals for confidential emotional support animal evaluations—from Chicago and its surrounding suburbs to central and southern Illinois.
          </p>
        </div>

...
const steps = [
  {
    ...
    description:
      "Complete a brief intake form and schedule a confidential consultation with an Illinois-licensed mental health professional through our HIPAA-compliant platform.",
  ...
  },
  {
    ...
    description:
      "Meet with a licensed clinician via secure audio or video call for a personalized ESA evaluation aligned with Fair Housing Act standards.",
  ...
  },
  {
    ...
    description:
      "If the clinician determines an ESA is appropriate, you'll receive a signed ESA letter by email on official letterhead from an Illinois-licensed provider.",
...
export function IllinoisProcessSection() {
  const scrollToForm = () => {
    ...
    >
      <div className="max-w-[1260px] mx-auto">
        ...
        <div className="text-center max-w-[1050px] mx-auto mb-14 sm:mb-16">
          <h2 className="font-heading text-2xl sm:text-3xl lg:text-[40px] xl:text-[44px] font-bold text-[#1E3E47] leading-[1.18] tracking-tight mb-4 md:whitespace-nowrap"> How the ESA Evaluation Process Works in Illinois </h2>
          <p className="font-sans text-sm sm:text-base lg:text-[16.5px] text-[#5F6B6F] font-medium leading-[1.65]">
            Our process is simple, secure, and compliant with Illinois state laws and federal Fair Housing Act guidelines.
          </p>
        </div>

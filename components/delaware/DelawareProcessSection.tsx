...
const steps = [
  {
    ...
    description:
      "Create an account and schedule a telehealth appointment with a Delaware-licensed mental health professional authorized to conduct ESA evaluations.",
...
const differentiators = [
  ...
  "Fair Housing Act & Delaware compliant documentation.",
  "Delaware licensed mental health professionals only.",
  "HIPAA-compliant, secure telehealth platform.",
];

export function DelawareProcessSection() {
  const scrollToForm = () => {
      ...
      <div className="max-w-[1260px] mx-auto">
        ...
        <div className="text-center max-w-[820px] mx-auto mb-14 sm:mb-16">
          <h2 className="font-heading text-3xl sm:text-4xl lg:text-[44px] font-bold text-[#1E3E47] leading-[1.18] tracking-tight mb-4">
            How the Delaware ESA Evaluation
          ...
          <p className="font-sans text-sm sm:text-base lg:text-[16.5px] text-[#5F6B6F] font-medium leading-[1.65]">
            Our platform helps Delaware residents connect with licensed mental health professionals for

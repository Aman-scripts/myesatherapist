...
export function DelawareLawsSection() {
  return (
      ...
      <div className="max-w-[1060px] mx-auto">
        ...
        <div className="text-center max-w-[820px] mx-auto mb-8 sm:mb-10 lg:mb-12">
          <h2 className="font-heading text-2xl sm:text-3xl lg:text-[36px] xl:text-[40px] font-bold text-[#1E3E47] leading-[1.2] tracking-tight mb-3">
            Housing Accommodations For Emotional Support Animals in Delaware
          </h2>
          <p className="font-sans text-xs sm:text-sm lg:text-[14.5px] text-[#5F6B6F] font-medium leading-relaxed max-w-[760px] mx-auto">
            In Delaware, emotional support animal housing protections strictly align with the federal Fair Housing Act (FHA), ensuring individuals with qualifying disabilities are granted reasonable accommodations.
          </p>
        </div>
              ...
              <div className="space-y-4 flex-1">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="font-sans text-[11px] sm:text-[12px] lg:text-[12.5px] text-[#5F6B6F] font-medium leading-relaxed">
                      Landlords and property managers in Delaware are expected to evaluate ESA requests promptly and without unnecessary delay.
                    </p>
                  </div>
                </div>

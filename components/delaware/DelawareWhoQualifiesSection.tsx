...
const conditions = [
  {
    ...
    description: "Persistent depression affecting about 1 in 5 individuals in Delaware.",
    icon: "/whomayqualifies-moodconditions.svg",
  },
  {
    title: "Generalized Anxiety Disorder (GAD)",
    description: "Chronic anxiety impacting daily functioning and emotional wellbeing.",
    icon: "/whomayqualifies-california_chronicworry.svg",
  },
  {
    title: "Post-Traumatic Stress Disorder (PTSD)",
    description: "Trauma-related symptoms causing distress and anxiety.",
    icon: "/whomayqualifies-california_posttrauma.svg",
  },
  {
    title: "Other Mental Health Conditions",
    description: "Other emotional challenges evaluated by a licensed clinician.",
    icon: "/whomayqualifies-panicattack.svg",
  },
];

export function DelawareWhoQualifiesSection() {
  return (
          ...
          <div className="order-1 lg:order-2 lg:col-span-5 relative flex justify-end items-center w-full">
            ...
            <div className="sm:hidden relative w-full aspect-[390/440]">
              <Image
                ...
                alt="Who May Qualify for an ESA Letter in Delaware Mobile View"
                fill
                priority
                unoptimized
            ...
            <div className="hidden sm:block lg:hidden relative w-full aspect-[834/943]">
              <Image
                ...
                alt="Who May Qualify for an ESA Letter in Delaware Tablet View"
                fill
                priority
                unoptimized
                className="object-cover object-top"
            ...
            <div className="hidden lg:flex items-center justify-end w-full h-full">
              <div className="relative w-full max-h-[620px] aspect-[694/827] ml-auto">
                <Image
                  ...
                  alt="Who May Qualify for an ESA Letter in Delaware"
                  fill
                  priority
                  unoptimized
          ...
          <div className="order-2 lg:order-1 lg:col-span-7 px-4 sm:px-6 lg:px-0 py-2 sm:py-4 lg:py-6 pr-0 lg:pr-2 xl:pr-4 flex flex-col justify-center">
            ...
            <div className="mb-4 lg:mb-4">
              <h2 className="font-heading text-2xl sm:text-3xl lg:text-[32px] xl:text-[42px] font-bold text-[#1E3E47] leading-[1.16] tracking-tight mb-2">
                ...
                <br />
                ESA Letter in Delaware?
              </h2>
              <p className="font-sans text-xs sm:text-sm lg:text-[13px] xl:text-base text-[#5F6B6F] font-medium leading-[1.5] max-w-[540px]">
                Individuals living in Delaware with finding troubles and challenges in completing day-to-day tasks
                and activities can get themselves evaluated by a medical professional to check the need for an emotional support animal.
              </p>
            </div>

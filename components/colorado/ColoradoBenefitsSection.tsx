...
const financialBenefits = [
  {
    ...
    description:
      "Housing providers must make reasonable accommodations for your ESA, even in “no-pet” housing, ensuring your need for support is respected.",
    icon: "/whomayqualifies-california_chronicworry.svg",
  },
  {
    title: "Privacy and Reduced Paperwork",
    description:
      "A valid ESA letter helps protect your personal health information, so you don’t have to share unnecessary medical details while securing your housing.",
    icon: "/california-benefits-workplaceconsideration.svg",
  },
  {
    title: "Avoid Unexpected Pet Fees",
    description:
      "Your ESA letter shields you from extra costs such as pet rent or pet deposits that landlords might otherwise charge.",
    icon: "/california-benefits-workplaceconsideration.svg",
  },
];
...
const emotionalBenefits = [
  {
    ...
    description:
      "An ESA can provide grounding support and emotional stability when you’re feeling stressed or overwhelmed.",
    icon: "/whomayqualifies-panicattack.svg",
  },
  {
    title: "Reduced Feelings of Isolation",
    description:
      "The companionship of an ESA can ease loneliness and offer reliable emotional support.",
    icon: "/california-benefits-strongersense.svg",
  },
  {
    title: "Encouragement and Motivation",
    description:
      "Having an ESA nearby can gently inspire you to stay active, follow daily routines, and maintain a sense of purpose.",
    icon: "/california-benefits-strongersense.svg",
  },
];
...
export function ColoradoBenefitsSection() {
  return (
          ...
          <div className="order-1 lg:order-2 lg:col-span-5 relative flex justify-end items-stretch w-full">
            ...
            <div className="sm:hidden relative w-full aspect-[390/513]">
              <Image
                ...
                alt="Benefits of a Clinically Issued ESA Letter in Colorado Mobile View"
                fill
                priority
                unoptimized
            ...
            <div className="hidden sm:block lg:hidden relative w-full aspect-[834/1050]">
              <Image
                ...
                alt="Benefits of a Clinically Issued ESA Letter in Colorado Tablet View"
                fill
                priority
                unoptimized
                className="object-cover object-top"
            ...
            <div className="hidden lg:block relative w-full h-full lg:min-h-0 flex items-stretch">
              <Image
                ...
                alt="Benefits of a Clinically Issued ESA Letter in Colorado"
                fill
                priority
                unoptimized
          ...
          <div className="order-2 lg:order-1 lg:col-span-7 px-4 sm:px-6 lg:px-0 py-2 sm:py-4 lg:py-5 xl:py-12 pr-0 lg:pr-3 xl:pr-4 flex flex-col justify-center">
            ...
            <div className="mb-4 lg:mb-5 xl:mb-8">
              <h2 className="font-heading text-2xl sm:text-3xl lg:text-[29px] xl:text-[42px] font-bold text-[#1E3E47] leading-[1.16] tracking-tight mb-2 lg:mb-2.5">
                Benefits of a Clinically Issued Emotional Support Animal Letter in Colorado
              </h2>
              <p className="font-sans text-xs sm:text-sm lg:text-[12px] xl:text-base text-[#5F6B6F] font-medium leading-relaxed max-w-[520px]">
                When clinically appropriate and properly issued, ESA documentation can help clarify certain housing-related considerations under applicable fair housing guidance. Outcomes vary by housing provider and circumstance.
              </p>
            </div>

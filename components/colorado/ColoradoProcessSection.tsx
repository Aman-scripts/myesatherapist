...
const steps = [
  {
    ...
    description:
      "Sign up on the portal to book your appointment with a licensed mental health expert authorized to practice in Colorado.",
  ...
  },
  {
    ...
    description:
      "In a private audio or video session, a licensed mental health professional will evaluate whether an emotional support animal may be clinically appropriate for your emotional and mental well-being.",
  ...
  },
  {
    ...
    description:
      "If the licensed mental health professional determines that ESA support is clinically appropriate, your ESA letter will be sent directly to your email.",
    ...
    >
      <div className="max-w-[1260px] mx-auto">
        ...
        <div className="text-center max-w-[1050px] mx-auto mb-14 sm:mb-16">
          <h2 className="font-heading text-2xl sm:text-3xl lg:text-[40px] xl:text-[44px] font-bold text-[#1E3E47] leading-[1.18] tracking-tight mb-4 md:whitespace-nowrap"> How the ESA Evaluation Process Works in Colorado? </h2>
          <p className="font-sans text-sm sm:text-base lg:text-[16.5px] text-[#5F6B6F] font-medium leading-[1.65]">
            At My ESA Therapist, the focus is on providing access to a structured ESA evaluation process conducted by independent and licensed clinical social workers.
          </p>
        </div>

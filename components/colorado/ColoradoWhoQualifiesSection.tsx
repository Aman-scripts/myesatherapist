...
const conditions = [
  {
    ...
    description: "Ongoing symptoms of anxiety, such as excessive worry or tension, that may affect concentration or daily functioning.",
    icon: "/whomayqualifies-california_chronicworry.svg",
  },
  {
    title: "Depressive-Related Conditions",
    description: "Persistent sadness, reduced motivation, or emotional heaviness that may affect daily routines.",
    icon: "/whomayqualifies-moodconditions.svg",
  },
  {
    title: "Panic-Related Symptoms",
    description: "Episodes of intense fear or panic-like symptoms that may impact emotional balance or daily functioning.",
    icon: "/whomayqualifies-panicattack.svg",
  },
  {
    title: "Other Mental Health Conditions",
    description: "Other emotional and mental health concerns such as attention, mood regulation, trauma related symptoms or phobias.",
    icon: "/whomayqualifies-california_posttrauma.svg",
  },
];

export function ColoradoWhoQualifiesSection() {
  return (
          ...
          <div className="order-1 lg:order-2 lg:col-span-5 relative flex justify-end items-stretch w-full">
            ...
            <div className="sm:hidden relative w-full aspect-[390/440]">
              <Image
                ...
                alt="Who Qualifies For an ESA Letter in Colorado Mobile View"
                fill
                priority
                unoptimized
            ...
            <div className="hidden sm:block lg:hidden relative w-full aspect-[834/943]">
              <Image
                ...
                alt="Who Qualifies For an ESA Letter in Colorado Tablet View"
                fill
                priority
                unoptimized
                className="object-cover object-top"

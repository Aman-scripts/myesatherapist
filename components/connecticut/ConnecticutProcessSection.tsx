...
const steps = [
  {
    ...
    description:
      "Create an account and schedule a telehealth appointment with a Connecticut-licensed mental health professional authorized to conduct ESA evaluations.",
    offsetClass: "md:translate-y-0",
  },
  {
    number: "02",
    icon: "/californina-esa-evalutation_clinicalevaluation.svg",
    title: "Clinical Evaluation & Consultation",
    description:
      "Meet privately via secure audio or video consultation. The clinician assesses your emotional health needs and current symptoms under telehealth standards.",
  ...
  },
  {
    ...
    description:
      "If the clinician determines that an emotional support animal is appropriate for your care, an official FHA-compliant ESA letter is issued securely.",
...
const differentiators = [
  ...
  "Fair Housing Act & Connecticut compliant documentation.",
  "Connecticut licensed mental health professionals only.",
  "HIPAA-compliant, secure telehealth platform.",
];

export function ConnecticutProcessSection() {
  const scrollToForm = () => {
  ...
  return (
    ...
    >
      <div className="max-w-[1260px] mx-auto">
        ...
        {/* Header */}
        <div className="text-center max-w-[820px] mx-auto mb-14 sm:mb-16">
          <h2 className="font-heading text-3xl sm:text-4xl lg:text-[44px] font-bold text-[#1E3E47] leading-[1.18] tracking-tight mb-4">
            How the Connecticut ESA Evaluation
            <br className="hidden sm:block" /> Process Works?
          </h2>
          <p className="font-sans text-sm sm:text-base lg:text-[16.5px] text-[#5F6B6F] font-medium leading-[1.65]">
            Our platform helps Connecticut residents connect with licensed mental health professionals for
            ESA evaluations conducted through secure telehealth in accordance with state guidelines and federal housing laws.
          </p>
        </div>
        ...
        {/* Why Our Process Is Different Container */}
        <div className="bg-[#FAF5EB] rounded-[32px] sm:rounded-[36px] border border-[#EFE8DC] p-8 sm:p-10 lg:p-12 max-w-[760px] mx-auto shadow-xs">

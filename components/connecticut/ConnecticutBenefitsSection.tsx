...
const financialBenefits = [
  {
    title: "Housing Flexibility in Connecticut",
    description:
      "An ESA letter allows individuals with qualifying conditions to seek housing accommodation even in properties with strict no-pets policies.",
    icon: "/whomayqualifies-california_chronicworry.svg",
  },
  {
    title: "No Breed or Size Restrictions",
    description:
      "Under federal fair housing protections, landlords cannot deny an ESA based on breed or weight limits, provided the animal does not pose a direct threat.",
    icon: "/california-benefits-workplaceconsideration.svg",
  },
  {
    title: "Exemption from Pet Fees & Deposits",
    description:
      "Approved emotional support animals are exempt from pet deposits, extra monthly pet rent, and pet application fees.",
    icon: "/california-benefits-workplaceconsideration.svg",
  },
];
...
const emotionalBenefits = [
  {
    title: "Non-Judgmental Companionship",
    description:
      "An ESA provides constant comfort and unconditional affection, helping alleviate feelings of loneliness and isolation.",
    icon: "/whomayqualifies-panicattack.svg",
  },
  {
    title: "Increased Sense of Home Security",
    description:
      "Having an ESA at home can foster an increased sense of physical and emotional grounding, easing anxiety during rest and routine.",
    icon: "/california-benefits-strongersense.svg",
  },
  {
    title: "Supports Positive Daily Routines",
    description:
      "Caring for an ESA encourages regular feeding, exercise, and interaction, fostering structure and emotional stability.",
    icon: "/california-benefits-strongersense.svg",
  },
];
...
export function ConnecticutBenefitsSection() {
  return (
          ...
          <div className="order-1 lg:order-2 lg:col-span-5 relative flex justify-end items-stretch w-full">
            ...
            <div className="sm:hidden relative w-full aspect-[390/513]">
              <Image
                ...
                alt="Benefits of Having an ESA Letter in Connecticut Mobile View"
                fill
                priority
                unoptimized
            ...
            <div className="hidden sm:block lg:hidden relative w-full aspect-[834/1050]">
              <Image
                ...
                alt="Benefits of Having an ESA Letter in Connecticut Tablet View"
                fill
                priority
                unoptimized
                className="object-cover object-top"
            ...
            <div className="hidden lg:block relative w-full h-full lg:min-h-0 flex items-stretch">
              <Image
                ...
                alt="Benefits of Having an ESA Letter in Connecticut"
                fill
                priority
                unoptimized
          ...
          <div className="order-2 lg:order-1 lg:col-span-7 px-4 sm:px-6 lg:px-0 py-2 sm:py-4 lg:py-5 xl:py-12 pr-0 lg:pr-3 xl:pr-4 flex flex-col justify-center">
            ...
            <div className="mb-4 lg:mb-5 xl:mb-8">
              ...
              <p className="font-sans text-xs sm:text-sm lg:text-[12px] xl:text-base text-[#5F6B6F] font-medium leading-relaxed max-w-[520px]">
                Look at the ways in which an emotional support animal letter in Connecticut can help

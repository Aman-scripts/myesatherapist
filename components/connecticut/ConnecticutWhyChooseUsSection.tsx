...
const features = [
  {
    ...
    description:
      "All assessments are conducted directly by licensed mental health professionals authorized to practice in Connecticut.",
  },
  {
...
export function ConnecticutWhyChooseUsSection() {
  return (
      ...
      <div className="max-w-[1260px] mx-auto">
        <div className="text-center max-w-[800px] mx-auto mb-12 sm:mb-16">
          <h2 className="font-heading text-2xl sm:text-3xl lg:text-[40px] font-bold tracking-tight mb-4 text-[#F5E5D0]">
            Why Choose My ESA Therapist in Connecticut?
          </h2>
          <p className="font-sans text-xs sm:text-sm lg:text-[15px] text-[#E2E8F0] font-medium leading-relaxed">
            We prioritize clinical integrity, privacy, and transparent support to help Connecticut residents navigate the ESA process with confidence.
          </p>
        </div>

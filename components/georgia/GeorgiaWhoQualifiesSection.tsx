...
const conditions = [
  {
    ...
    description: "Reliving past traumatic events and difficulty trusting.",
    icon: "/whomayqualifies-california_posttrauma.svg",
  },
  {
    title: "Obsessive-Compulsive Disorder (OCD)",
    description: "Persistent intrusive thoughts affecting focus and routine.",
    icon: "/whomayqualifies-california_chronicworry.svg",
  },
  {
    title: "Social Anxiety Disorder",
    description: "Trouble forming and maintaining relationships with fear of neglect.",
    icon: "/whomayqualifies-panicattack.svg",
  },
  {
    title: "Generalized Depression & Anxiety",
    description: "Frequent anxiety, panic attacks, or persistent low mood.",
    icon: "/whomayqualifies-moodconditions.svg",
  },
];

export function GeorgiaWhoQualifiesSection() {
  return (
          ...
          <div className="order-1 lg:order-2 lg:col-span-5 relative flex justify-end items-center w-full">
            ...
            <div className="sm:hidden relative w-full aspect-[390/440]">
              <Image
                ...
                alt="Who May Qualify for an ESA Letter in Georgia Mobile View"
                fill
                priority
                unoptimized
            ...
            <div className="hidden sm:block lg:hidden relative w-full aspect-[834/943]">
              <Image
                ...
                alt="Who May Qualify for an ESA Letter in Georgia Tablet View"
                fill
                priority
                unoptimized
                className="object-cover object-top"
            ...
            <div className="hidden lg:flex items-center justify-end w-full h-full">
              <div className="relative w-full max-h-[620px] aspect-[694/827] ml-auto">
                <Image
                  ...
                  alt="Who qualifies for Georgia ESA Letter"
                  fill
                  priority
                  unoptimized

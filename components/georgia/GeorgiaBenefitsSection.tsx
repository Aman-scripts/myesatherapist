...
const financialBenefits = [
  {
    ...
    description:
      "Request housing accommodations to live with your emotional support animal even in properties with strict no-pet rules.",
    icon: "/whomayqualifies-california_chronicworry.svg",
  },
  {
    title: "Skip Unnecessary Pet Fees",
    description:
      "Under federal housing guidelines, common pet rent and pet deposit charges are waived when valid ESA documentation is presented.",
    icon: "/california-benefits-workplaceconsideration.svg",
  },
  {
    title: "No Breed or Size Restrictions",
    description:
      "Landlords cannot enforce standard breed, weight, or size limits on emotional support animals in Georgia housing.",
    icon: "/california-benefits-workplaceconsideration.svg",
  },
];
...
const emotionalBenefits = [
  {
    ...
    description:
      "Having an emotional support animal nearby helps reduce and calm daily stress and anxiety-related symptoms.",
    icon: "/whomayqualifies-panicattack.svg",
  },
  {
    title: "Improved Emotional Balance",
    description:
      "Ongoing companionship of an ESA provides steady reassurance, helping individuals maintain emotional balance.",
    icon: "/california-benefits-strongersense.svg",
  },
  {
    title: "Encouraging Purpose and Routine",
    description:
      "Caring for an ESA creates a sense of routine, daily value, and responsibility that supports overall mental wellness.",
    icon: "/california-benefits-strongersense.svg",
  },
];
...
export function GeorgiaBenefitsSection() {
  return (
          ...
          <div className="order-1 lg:order-2 lg:col-span-5 relative flex justify-end items-stretch w-full">
            ...
            <div className="sm:hidden relative w-full aspect-[390/513]">
              <Image
                ...
                alt="Benefits of Having an ESA Letter in Georgia Mobile View"
                fill
                priority
                unoptimized
            ...
            <div className="hidden sm:block lg:hidden relative w-full aspect-[834/1050]">
              <Image
                ...
                alt="Benefits of Having an ESA Letter in Georgia Tablet View"
                fill
                priority
                unoptimized
                className="object-cover object-top"
            ...
            <div className="hidden lg:block relative w-full h-full lg:min-h-0 flex items-stretch">
              <Image
                ...
                alt="Benefits of Having an ESA Letter in Georgia"
                fill
                priority
                unoptimized
          ...
          <div className="order-2 lg:order-1 lg:col-span-7 px-4 sm:px-6 lg:px-0 py-2 sm:py-4 lg:py-5 xl:py-12 pr-0 lg:pr-3 xl:pr-4 flex flex-col justify-center">
            ...
            <div className="mb-4 lg:mb-5 xl:mb-8">
              ...
              <p className="font-sans text-xs sm:text-sm lg:text-[12px] xl:text-base text-[#5F6B6F] font-medium leading-relaxed max-w-[520px]">
                Look at the ways in which an emotional support animal letter in Georgia offers accommodation benefits and supports overall mental and emotional well-being.
              </p>
            </div>

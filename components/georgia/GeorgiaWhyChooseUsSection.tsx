...
const features = [
  {
    ...
    description:
      "Evaluations are conducted by independent U.S.-licensed mental health professionals authorized to assess ESA eligibility in Georgia.",
  },
  {
  ...
  },
  {
    ...
    description:
      "When clinically appropriate, ESA letters are issued in compliance with applicable federal and Georgia state housing guidelines.",
  },
  {
    icon: "/whychoose-section-nationwide-access.svg",
    title: "Nationwide Access",
    description:
      "Telehealth evaluations available for individuals across Georgia and the United States, subject to clinician availability.",
  },
  {
...
export function GeorgiaWhyChooseUsSection() {
  return (

...
export function GeorgiaLawsSection() {
  return (
      ...
      <div className="max-w-[1060px] mx-auto">
        ...
        <div className="text-center max-w-[820px] mx-auto mb-8 sm:mb-10 lg:mb-12">
          <h2 className="font-heading text-2xl sm:text-3xl lg:text-[36px] xl:text-[40px] font-bold text-[#1E3E47] leading-[1.2] tracking-tight mb-3">
            Understand Your Georgia ESA Laws for Housing & Accommodation Rights
          </h2>
          <p className="font-sans text-xs sm:text-sm lg:text-[14.5px] text-[#5F6B6F] font-medium leading-relaxed max-w-[760px] mx-auto">
            Georgia adheres to federal housing guidelines regarding emotional support animals. This set of rules explains how individuals may request housing accommodation and clarifies the responsibilities of housing providers.
          </p>
        </div>
              ...
              <div className="space-y-4 flex-1">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="font-sans text-xs sm:text-[13.5px] lg:text-[14px] font-bold text-[#1E3E47] mb-1">
                      Fair Housing Act (FHA) Considerations
                    </h4>
                    <p className="font-sans text-[11px] sm:text-[12px] lg:text-[12.5px] text-[#5F6B6F] font-medium leading-relaxed">
                      The Fair Housing Act allows individuals with a verified need for an emotional support animal to seek reasonable housing accommodations, even in residences with pet restrictions.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="font-sans text-[11px] sm:text-[12px] lg:text-[12.5px] text-[#5F6B6F] font-medium leading-relaxed">
                      Under federal housing guidance, ESAs are not categorized as pets. When valid ESA documents are provided and approved, common pet rent or deposits are typically not imposed.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="font-sans text-xs sm:text-[13.5px] lg:text-[14px] font-bold text-[#1E3E47] mb-1">
                      Housing Evaluation Standards
                    </h4>
                    <p className="font-sans text-[11px] sm:text-[12px] lg:text-[12.5px] text-[#5F6B6F] font-medium leading-relaxed">
                      Housing providers must assess ESA accommodation requests individually and may not enforce typical pet rules related to breed, weight, or size during review.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-4 flex-1">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="font-sans text-[11px] sm:text-[12px] lg:text-[12.5px] text-[#5F6B6F] font-medium leading-relaxed">
                      Housing providers are allowed to review an ESA letter to ensure it was issued after a legitimate professional assessment with proper provider licensing details.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="font-sans text-xs sm:text-[13.5px] lg:text-[14px] font-bold text-[#1E3E47] mb-1">
                      Community and Property Policies
                    </h4>
                    <p className="font-sans text-[11px] sm:text-[12px] lg:text-[12.5px] text-[#5F6B6F] font-medium leading-relaxed">
                      General property rules regarding cleanliness and noise apply as long as they do not limit or interfere with an approved emotional support animal accommodation.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="font-sans text-xs sm:text-[13.5px] lg:text-[14px] font-bold text-[#1E3E47] mb-1">
                      Health, Safety, and Property Considerations
                    </h4>
                    <p className="font-sans text-[11px] sm:text-[12px] lg:text-[12.5px] text-[#5F6B6F] font-medium leading-relaxed">
                      An accommodation request can be denied if the animal presents a verified direct threat to health or safety or causes major property damage.
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="max-w-[840px] mx-auto bg-[#FCF6E8] rounded-[18px] sm:rounded-[22px] overflow-hidden flex items-stretch shadow-[0_4px_20px_rgba(0,0,0,0.02)]">
          ...
          <div className="p-4 sm:p-5 lg:p-6 flex-1">
            ...
            <p className="font-sans text-[11px] sm:text-xs lg:text-[12.5px] text-[#5F6B6F] font-medium leading-relaxed">
              Emotional support animals have housing accommodation rights under the Fair Housing Act in Georgia, but generally do not have public access rights like service animals in public places. Airlines also set independent animal travel policies under the Air Carrier Access Act.
            </p>
          </div>
        </div>

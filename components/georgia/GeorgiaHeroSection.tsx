      ...
      {isSubmitted ? (
        <div className="py-6 text-center space-y-3 animate-fadeIn">
          ...
          <p className="text-xs text-[#5F6B6F] font-medium">
            Our Georgia intake specialist is reviewing your submission.
          </p>
        </div>
      ) : (
...
export function GeorgiaHeroSection() {
    ...
    <section className="relative w-full bg-[#FAF7F2] overflow-hidden">
      ...
      <div className="hidden lg:block relative w-full aspect-[4320/2439] min-h-[640px] lg:min-h-[680px] xl:min-h-[820px]">
        <Image
          ...
          alt="Georgia ESA Letter Evaluations by Licensed Professionals"
          fill
          priority
          unoptimized
          ...
          <div className="max-w-[1360px] mx-auto h-full px-6 lg:px-8 xl:px-10 flex items-start justify-between pt-6 lg:pt-7 xl:pt-14">
            ...
            <div className="w-[48%] lg:w-[42%] xl:w-[45%] space-y-3 lg:space-y-4 xl:space-y-6 pt-1">
              <h1 className="font-heading text-3xl md:text-4xl lg:text-[28px] xl:text-[46px] 2xl:text-[52px] font-bold text-[#1E3E47] leading-[1.15] xl:leading-[54px] 2xl:leading-[60px] tracking-[-0.011em]">
                <span className="whitespace-nowrap">Georgia ESA Letter</span>
                <br />
                Evaluations by
                <br />
      ...
      <div className="hidden sm:block lg:hidden relative w-full aspect-[834/1774] max-w-[834px] mx-auto overflow-hidden">
        <Image
          ...
          alt="Georgia ESA Evaluations Tablet View"
          fill
          priority
          unoptimized
          className="object-cover object-top pointer-events-none"
      ...
      <div className="sm:hidden relative w-full aspect-[390/1298] overflow-hidden">
        <Image
          ...
          alt="Georgia ESA Evaluations Mobile View"
          fill
          priority
          unoptimized
          className="object-cover object-top pointer-events-none"

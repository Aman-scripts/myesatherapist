...
const steps = [
  {
    ...
    description:
      "Quick and Easy Booking. Select a convenient time to meet with a Georgia-licensed mental health professional authorized to conduct ESA evaluations.",
  ...
  },
  {
    ...
    description:
      "Secure & Confidential Assessment. Participate in a private telehealth evaluation where your emotional health needs and symptoms are thoroughly assessed.",
  ...
  },
  {
    ...
    description:
      "Legally Compliant Documentation. If clinically appropriate, receive your official FHA-compliant Georgia ESA letter issued directly by your clinician.",
    offsetClass: "md:translate-y-16 lg:translate-y-24",
  },
];

const differentiators = [
  "HIPAA-compliant, secure telehealth consultations.",
  "No hidden fees & transparent process.",
  "Georgia-licensed mental health professionals only.",
  "Legitimate documentation adhering to federal housing laws.",
];

export function GeorgiaProcessSection() {
  const scrollToForm = () => {
      ...
      <div className="max-w-[1260px] mx-auto">
        ...
        <div className="text-center max-w-[820px] mx-auto mb-14 sm:mb-16">
          <h2 className="font-heading text-3xl sm:text-4xl lg:text-[44px] font-bold text-[#1E3E47] leading-[1.18] tracking-tight mb-4">
            How the Georgia ESA Evaluation
          ...
          <p className="font-sans text-sm sm:text-base lg:text-[16.5px] text-[#5F6B6F] font-medium leading-[1.65]">
            Our platform connects Georgia residents with licensed mental health professionals for secure telehealth ESA evaluations in accordance with state guidelines and federal housing laws.
          </p>
        </div>
        ...
        <div className="bg-[#FAF5EB] rounded-[32px] sm:rounded-[36px] border border-[#EFE8DC] p-8 sm:p-10 lg:p-12 max-w-[760px] mx-auto shadow-xs">
          <h3 className="font-heading text-2xl sm:text-3xl font-bold text-[#1E3E47] text-center mb-8">
            Why Our ESA Letter Georgia Process Stands Out?
          </h3>

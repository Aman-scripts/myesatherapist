...
const conditions = [
  {
    ...
    description: "Frequent mild mood swings affecting stability.",
    icon: "/whomayqualifies-california_chronicworry.svg",
  },
  {
    title: "Avoidant Personality Disorder",
    description: "Extreme fear of criticism and rejection.",
    icon: "/whomayqualifies-panicattack.svg",
  },
  {
    title: "Adjustment Disorder",
    description: "Stress reaction to major life changes.",
    icon: "/whomayqualifies-california_posttrauma.svg",
  },
  {
    title: "Agoraphobia",
    description: "Fear of public or hard-to-escape places.",
    icon: "/whomayqualifies-moodconditions.svg",
  },
];

export function MassachusettsWhoQualifiesSection() {
  return (
          ...
          <div className="order-1 lg:order-2 lg:col-span-5 relative flex justify-end items-center w-full">
            ...
            <div className="sm:hidden relative w-full aspect-[390/440]">
              <Image
                ...
                alt="Who May Qualify for an ESA Letter in Massachusetts Mobile View"
                fill
                priority
                unoptimized
            ...
            <div className="hidden sm:block lg:hidden relative w-full aspect-[834/943]">
              <Image
                ...
                alt="Who May Qualify for an ESA Letter in Massachusetts Tablet View"
                fill
                priority
                unoptimized
                className="object-cover object-top"
            ...
            <div className="hidden lg:flex items-center justify-end w-full h-full">
              <div className="relative w-full max-h-[620px] aspect-[694/827] ml-auto">
                <Image
                  ...
                  alt="Who qualifies for Massachusetts ESA Letter"
                  fill
                  priority
                  unoptimized

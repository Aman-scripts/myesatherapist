...
const financialBenefits = [
  {
    ...
    description:
      "Even in residences with “no pet” policies, an ESA letter Massachusetts permits people with qualifying mental health issues to live with their emotional support animal.",
    icon: "/whomayqualifies-california_chronicworry.svg",
  },
  {
    title: "Reduced Anxiety-Related Costs",
    description:
      "By managing symptoms like anxiety, sadness, or PTSD, an ESA may lessen the need for frequent doctor visits, therapy sessions, or medication changes.",
    icon: "/california-benefits-workplaceconsideration.svg",
  },
  {
    title: "Lower Relocation Expenses",
    description:
      "An ESA letter can help individuals avoid the need to move due to restrictive pet policies, saving on costs such as moving services and security deposits.",
    icon: "/california-benefits-workplaceconsideration.svg",
  },
];
...
const emotionalBenefits = [
  {
    ...
    description:
      "By offering warmth, company, and emotional stability during long winter months, an ESA can help overcome seasonal mood swings.",
    icon: "/whomayqualifies-panicattack.svg",
  },
  {
    title: "Enhanced Coping Skills",
    description:
      "An ESA can help people manage triggers for panic attacks, social anxiety, and PTSD, offering comfort and a sense of stability.",
    icon: "/california-benefits-strongersense.svg",
  },
  {
    title: "Encourages Consistent Daily Routines",
    description:
      "To assist people with anxiety or depression in maintaining regular routines, caring for an ESA encourages structure and daily interaction.",
    icon: "/california-benefits-strongersense.svg",
  },
];
...
export function MassachusettsBenefitsSection() {
  return (
          ...
          <div className="order-1 lg:order-2 lg:col-span-5 relative flex justify-end items-stretch w-full">
            ...
            <div className="sm:hidden relative w-full aspect-[390/513]">
              <Image
                ...
                alt="Benefits of Having an ESA Letter in Massachusetts Mobile View"
                fill
                priority
                unoptimized
            ...
            <div className="hidden sm:block lg:hidden relative w-full aspect-[834/1050]">
              <Image
                ...
                alt="Benefits of Having an ESA Letter in Massachusetts Tablet View"
                fill
                priority
                unoptimized
                className="object-cover object-top"
            ...
            <div className="hidden lg:block relative w-full h-full lg:min-h-0 flex items-stretch">
              <Image
                ...
                alt="Benefits of Having an ESA Letter in Massachusetts"
                fill
                priority
                unoptimized
          ...
          <div className="order-2 lg:order-1 lg:col-span-7 px-4 sm:px-6 lg:px-0 py-2 sm:py-4 lg:py-5 xl:py-12 pr-0 lg:pr-3 xl:pr-4 flex flex-col justify-center">
            <div className="mb-4 lg:mb-5 xl:mb-8">
              ...
              <p className="font-sans text-xs sm:text-sm lg:text-[12px] xl:text-base text-[#5F6B6F] font-medium leading-relaxed max-w-[520px]">
                Know how being eligible for a Massachusetts emotional support animal letter can improve your well-being and make living with your companion more enjoyable.
              </p>
            </div>

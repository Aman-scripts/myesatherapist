...
const wisconsinCities = [
  ...
  { name: "Eau Claire", icon: "/losangeles.svg" },
  { name: "Janesville", icon: "/sanfrancisco.svg" },
];

export function WisconsinAvailableCitiesSection() {
  return (
      ...
      <div className="max-w-[1060px] mx-auto">
        ...
        <div className="text-center max-w-[840px] mx-auto mb-10 sm:mb-12 lg:mb-14">
          ...
          <p className="font-sans text-xs sm:text-sm lg:text-[15px] text-[#5F6B6F] font-medium leading-relaxed mt-3 max-w-[760px] mx-auto">
            ...
            across all cities and counties in Wisconsin, from Milwaukee to Madison, Green Bay, and beyond.
          </p>
        </div>

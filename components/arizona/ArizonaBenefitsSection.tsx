...
const financialBenefits = [
  {
    title: "Housing & Reasonable Accommodations",
    description:
      "Under the Fair Housing Act, ESA letters help tenants request reasonable housing accommodations when standard pet policies create barriers to living with their support animal.",
    icon: "/whomayqualifies-california_chronicworry.svg",
  },
  {
    title: "Exemption from Pet Fees & Deposits",
    description:
      "With legitimate ESA documentation, landlords generally cannot charge extra pet rent or pet deposits.",
    icon: "/california-benefits-workplaceconsideration.svg",
  },
  {
    title: "No Breed or Weight Limits",
    description:
      "Housing providers cannot deny an ESA based on breed or weight, provided the animal does not pose a direct threat.",
    icon: "/california-benefits-workplaceconsideration.svg",
  },
];
...
const emotionalBenefits = [
  {
    title: "Improves Daily Routines",
    description:
      "Having an ESA may help improve daily routines and overall quality of life by encouraging physical activity and consistent habits.",
    icon: "/whomayqualifies-panicattack.svg",
  },
  {
    title: "Emotional Support & Reassurance",
    description:
      "Your support animal may help in stabilizing intense emotions, easing feelings of loneliness, and helping you feel more grounded.",
    icon: "/california-benefits-strongersense.svg",
  },
  {
    title: "Enhances Therapeutic Outcomes",
    description:
      "An ESA can complement formal therapy treatments by providing continuous emotional comfort in home environments.",
    icon: "/california-benefits-strongersense.svg",
  },
];
...
export function ArizonaBenefitsSection() {
  return (
          ...
          <div className="order-1 lg:order-2 lg:col-span-5 relative flex justify-end items-stretch w-full">
            ...
            <div className="sm:hidden relative w-full aspect-[390/513]">
              <Image
                ...
                alt="Benefits Of a Medically Approved ESA Letter in Arizona Mobile View"
                fill
                priority
                unoptimized
            ...
            <div className="hidden sm:block lg:hidden relative w-full aspect-[834/1050]">
              <Image
                ...
                alt="Benefits Of a Medically Approved ESA Letter in Arizona Tablet View"
                fill
                priority
                unoptimized
                className="object-cover object-top"
            ...
            <div className="hidden lg:block relative w-full h-full lg:min-h-0 flex items-stretch">
              <Image
                ...
                alt="Benefits Of a Medically Approved ESA Letter in Arizona"
                fill
                priority
                unoptimized
          ...
          <div className="order-2 lg:order-1 lg:col-span-7 px-4 sm:px-6 lg:px-0 py-2 sm:py-4 lg:py-5 xl:py-12 pr-0 lg:pr-3 xl:pr-4 flex flex-col justify-center">
            ...
            <div className="mb-4 lg:mb-5 xl:mb-8">
              <h2 className="font-heading text-2xl sm:text-3xl lg:text-[29px] xl:text-[42px] font-bold text-[#1E3E47] leading-[1.16] tracking-tight mb-2 lg:mb-2.5">
                Benefits of a Medically Approved ESA Letter in Arizona
              </h2>
              <p className="font-sans text-xs sm:text-sm lg:text-[12px] xl:text-base text-[#5F6B6F] font-medium leading-relaxed max-w-[520px]">
                A valid ESA letter issued by an Arizona-licensed mental health professional helps support housing-related accommodation requests under federal fair housing guidelines.
              </p>
            </div>

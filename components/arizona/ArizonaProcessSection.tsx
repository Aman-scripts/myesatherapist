...
const steps = [
  {
    ...
    description:
      "Complete a quick intake questionnaire and book a confidential consultation with an Arizona-licensed mental health professional.",
  ...
  },
  {
    ...
    description:
      "Meet with a licensed clinician via secure telehealth to evaluate your qualifying mental or emotional health condition under Fair Housing Act standards.",
    offsetClass: "md:translate-y-8 lg:translate-y-12",
  },
  {
    number: "03",
    icon: "/californina-esa-evalutation_clinicaldetermination.svg",
    title: "ESA Letter Issued",
    description:
      "If approved, receive a signed ESA recommendation letter on official letterhead from an Arizona-licensed mental health professional.",
...
const differentiators = [
  ...
  "Licensed Arizona mental health experts make all clinical decisions",
  "HIPAA-compliant, secure online platform for privacy and confidentiality",
];

export function ArizonaProcessSection() {
  const scrollToForm = () => {
    ...
    >
      <div className="max-w-[1260px] mx-auto">
        ...
        <div className="text-center max-w-[1050px] mx-auto mb-14 sm:mb-16">
          <h2 className="font-heading text-2xl sm:text-3xl lg:text-[40px] xl:text-[44px] font-bold text-[#1E3E47] leading-[1.18] tracking-tight mb-4 md:whitespace-nowrap"> How an ESA Evaluation Works in Arizona </h2>
          <p className="font-sans text-sm sm:text-base lg:text-[16.5px] text-[#5F6B6F] font-medium leading-[1.65]">
            Our process is simple, secure, and compliant with Arizona state laws and federal Fair Housing Act guidelines.
          </p>
        </div>

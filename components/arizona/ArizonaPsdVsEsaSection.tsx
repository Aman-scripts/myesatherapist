...
const esaBullets = [
  "Provide comfort and emotional stability for individuals experiencing anxiety, PTSD, and similar mental health challenges.",
  "Do not require specialized training.",
  "Protected under the Fair Housing Act (FHA) for housing accommodations.",
  "Do not have public-access rights to stores, restaurants, or businesses.",
];

const psdBullets = [
  "Specially trained to perform specific tasks that help prevent harm, provide safety support, or remind individuals to complete important daily activities.",
  "Protected under the Americans with Disabilities Act (ADA).",
  "Allowed in public places, including restaurants, stores, and most travel settings, where pets are normally restricted.",
];

export function ArizonaPsdVsEsaSection() {
  return (
      ...
      <div className="max-w-[1080px] mx-auto">
        ...
        <div className="text-center max-w-[840px] mx-auto mb-10 sm:mb-12 lg:mb-14">
          <h2 className="font-heading text-2xl sm:text-3xl lg:text-[38px] xl:text-[42px] font-bold text-[#1E3E47] leading-[1.2] tracking-tight">
            Psychiatric Service Dogs vs. Emotional Support Animals in Arizona
          </h2>
        ...
        <div className="max-w-[840px] mx-auto bg-[#FCF6E8] rounded-[18px] sm:rounded-[22px] overflow-hidden flex items-stretch shadow-[0_4px_20px_rgba(0,0,0,0.02)]">
          ...
          <div className="p-4 sm:p-5 lg:p-6 flex-1">
            <h3 className="font-heading text-sm sm:text-base lg:text-[17px] font-bold text-[#1E3E47] mb-1.5 leading-snug">
              Getting a Psychiatric Service Dog in Arizona
            </h3>
            <p className="font-sans text-[11px] sm:text-xs lg:text-[12.5px] text-[#5F6B6F] font-medium leading-relaxed">
              If you have a qualifying mental health condition and need a dog trained to perform specific tasks to assist you, a Psychiatric Service Dog may be appropriate. Our platform connects you with licensed mental health professionals in Arizona who can assess your eligibility for a PSD consultation.
            </p>
          </div>
        </div>

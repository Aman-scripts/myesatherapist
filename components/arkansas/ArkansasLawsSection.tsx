...
export function ArkansasLawsSection() {
  return (
      ...
      <div className="max-w-[1060px] mx-auto">
        ...
        <div className="text-center max-w-[840px] mx-auto mb-8 sm:mb-10 lg:mb-12">
          <h2 className="font-heading text-2xl sm:text-3xl lg:text-[36px] xl:text-[40px] font-bold text-[#1E3E47] leading-[1.2] tracking-tight mb-3">
            Housing Accommodations For Emotional Support Animals in Arkansas
          </h2>
          <p className="font-sans text-xs sm:text-sm lg:text-[14.5px] text-[#5F6B6F] font-medium leading-relaxed max-w-[760px] mx-auto">
            In Arkansas, ESA housing protections operate under federal Fair Housing Act (FHA) guidelines and state legislation (HB 1420), requiring a 30-day client-provider relationship for documentation.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-6 xl:gap-8 mb-10 lg:mb-12">
          ...
          {/* White Card 2 (Right): Arkansas State House Bill 1420 */}
          <div className="bg-white rounded-[20px] sm:rounded-[24px] lg:rounded-[26px] border border-[#EAE5DC] shadow-[0_4px_20px_rgba(0,0,0,0.025)] flex flex-col overflow-hidden">
            ...
            <div className="relative w-full aspect-[16/9] overflow-hidden shrink-0">
              <Image
                ...
                alt="Arkansas House Bill 1420 Compliance"
                fill
                priority
                unoptimized
                className="object-cover object-center"
            ...
            <div className="p-4.5 sm:p-5 lg:p-6 flex flex-col flex-1">
              ...
              {/* Title */}
              <h3 className="font-heading text-lg sm:text-xl lg:text-[21px] xl:text-[23px] font-bold text-[#1E3E47] text-center mb-4 sm:mb-5 leading-snug">
                Arkansas State Provisions (HB 1420)
              </h3>
              ...
              <div className="space-y-4 flex-1">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="font-sans text-xs sm:text-[13.5px] lg:text-[14px] font-bold text-[#1E3E47] mb-1">
                      30-Day Therapeutic Relationship Standard
                    </h4>
                    <p className="font-sans text-[11px] sm:text-[12px] lg:text-[12.5px] text-[#5F6B6F] font-medium leading-relaxed">
                      Arkansas HB 1420 requires an established clinician-client relationship of at least 30 days before issuing an ESA recommendation letter for housing.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="font-sans text-[11px] sm:text-[12px] lg:text-[12.5px] text-[#5F6B6F] font-medium leading-relaxed">
                      Housing providers in Arkansas cannot charge pet deposits, pet rent, or application fees for emotional support animals approved under FHA guidelines.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="font-sans text-[11px] sm:text-[12px] lg:text-[12.5px] text-[#5F6B6F] font-medium leading-relaxed">
                      Arkansas law penalizes misrepresenting a pet as an ESA or providing fraudulent documentation to landlords.
                    </p>
                  </div>
                </div>
              </div>

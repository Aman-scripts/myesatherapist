...
const financialBenefits = [
  {
    title: "Housing Protection Across Arkansas",
    description:
      "A valid ESA letter under FHA protections permits housing accommodation in apartments with pet restrictions or no-pet rules.",
    icon: "/whomayqualifies-california_chronicworry.svg",
  },
  {
    title: "Exemption From Pet Rent & Fees",
    description:
      "Landlords cannot impose pet deposits, monthly pet fees, or pet application fees for valid emotional support animals.",
    icon: "/california-benefits-workplaceconsideration.svg",
  },
  {
    title: "Protection Against Breed/Weight Limits",
    description:
      "Federal guidelines prohibit landlords from restricting an ESA based solely on breed, size, or weight classifications.",
    icon: "/california-benefits-workplaceconsideration.svg",
  },
];
...
const emotionalBenefits = [
  {
    title: "Daily Grounding & Routine Support",
    description:
      "Caring for an ESA fosters consistent routine habits, aiding stability for individuals managing depressive or anxiety conditions.",
    icon: "/whomayqualifies-panicattack.svg",
  },
  {
    title: "Reduced Isolation & Stress Relief",
    description:
      "Companion animals provide continuous non-judgmental presence, helping reduce social stress and emotional overwhelm.",
    icon: "/california-benefits-strongersense.svg",
  },
  {
    title: "Comfort in Home Environment",
    description:
      "An ESA supports a peaceful, secure living space, offering emotional comfort during panic attacks or hypervigilance.",
    icon: "/california-benefits-strongersense.svg",
  },
];
...
export function ArkansasBenefitsSection() {
  return (
          ...
          <div className="order-1 lg:order-2 lg:col-span-5 relative flex justify-end items-stretch w-full">
            ...
            <div className="sm:hidden relative w-full aspect-[390/513]">
              <Image
                ...
                alt="Benefits of Having an ESA Letter in Arkansas Mobile View"
                fill
                priority
                unoptimized
            ...
            <div className="hidden sm:block lg:hidden relative w-full aspect-[834/1050]">
              <Image
                ...
                alt="Benefits of Having an ESA Letter in Arkansas Tablet View"
                fill
                priority
                unoptimized
                className="object-cover object-top"
            ...
            <div className="hidden lg:block relative w-full h-full lg:min-h-0 flex items-stretch">
              <Image
                ...
                alt="Benefits of Having an ESA Letter in Arkansas"
                fill
                priority
                unoptimized
          ...
          <div className="order-2 lg:order-1 lg:col-span-7 px-4 sm:px-6 lg:px-0 py-2 sm:py-4 lg:py-5 xl:py-12 pr-0 lg:pr-3 xl:pr-4 flex flex-col justify-center">
            ...
            <div className="mb-4 lg:mb-5 xl:mb-8">
              ...
              <p className="font-sans text-xs sm:text-sm lg:text-[12px] xl:text-base text-[#5F6B6F] font-medium leading-relaxed max-w-[520px]">
                Look at the ways in which an emotional support animal letter in Arkansas can help

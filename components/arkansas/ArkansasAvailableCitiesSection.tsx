...
const arkansasCities = [
  ...
  { name: "Fort Smith", icon: "/sanfrancisco.svg" },
  { name: "Fayetteville", icon: "/losangelestwo.svg" },
  { name: "Springdale", icon: "/losangelesfour.svg" },
  { name: "Jonesboro", icon: "/losangelesthree.svg" },
  { name: "Rogers", icon: "/sanfranciscotwo.svg" },
  { name: "North Little Rock", icon: "/sanfranciscothree.svg" },
  { name: "Conway", icon: "/sanfranciscofour.svg" },
];

export function ArkansasAvailableCitiesSection() {
  return (
      ...
      <div className="max-w-[1060px] mx-auto">
        ...
        <div className="text-center max-w-[840px] mx-auto mb-10 sm:mb-12 lg:mb-14">
          <h2 className="font-heading text-2xl sm:text-3xl lg:text-[40px] xl:text-[44px] font-bold text-[#1E3E47] leading-[1.2] tracking-tight">
            Available Everywhere in Arkansas
          </h2>
          <p className="font-sans text-xs sm:text-sm lg:text-[15px] text-[#5F6B6F] font-medium leading-relaxed mt-3 max-w-[760px] mx-auto">
            ...
            across all cities and counties in Arkansas, from Little Rock to Fort Smith, Fayetteville, and Jonesboro.
          </p>
        </div>

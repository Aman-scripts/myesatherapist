...
const requirements = [
  ...
  "A mental or emotional health condition is diagnosed by a licensed professional.",
  "An established 30-day client-provider relationship is maintained (Arkansas HB 1420 requirement).",
  "The clinician determines that an emotional support animal offers therapeutic assistance.",
  "The individual resides in Arkansas or is moving to an Arkansas rental property.",
];

export function ArkansasRequirementsSection() {
  return (
      ...
      <div className="max-w-[840px] mx-auto">
        <div className="bg-[#F9F5EC] rounded-[24px] sm:rounded-[32px] border border-[#ECE4D5] p-6 sm:p-8 lg:p-10 shadow-sm text-center">
          ...
          <h2 className="font-heading text-xl sm:text-2xl lg:text-[26px] font-bold text-[#1E3E47] text-center mb-6 sm:mb-8 tracking-tight">
            Basic Requirements For Arkansas ESA Letter
          </h2>
          ...
          <div className="max-w-[720px] mx-auto relative overflow-hidden bg-[#FAF7F2] rounded-[14px] py-3.5 px-4 sm:px-6 border border-[#EAE5DC] shadow-xs flex items-center pl-6 sm:pl-7 text-left">
            ...
            <p className="font-sans text-[11.5px] sm:text-xs lg:text-[13px] font-medium text-[#5F6B6F] leading-relaxed">
              ...
              Under Arkansas HB 1420, documentation must come from a licensed mental health professional with whom you have an established 30-day therapeutic relationship.
            </p>
          </div>

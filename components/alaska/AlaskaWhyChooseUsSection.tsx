...
const features = [
  ...
  },
  {
    ...
    description:
      "HIPAA-compliant systems ensure your information remains confidential and protected across remote & urban Alaska.",
  },
  {
  ...
  },
  {
    ...
    title: "Statewide Access in Alaska",
    description:
      "Telehealth evaluations available for individuals across Alaska, from Anchorage to remote communities.",
  },
  {
...
export function AlaskaWhyChooseUsSection() {
  return (
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-14 lg:mb-20 space-y-2.5">
          ...
          <div className="text-[#5F6B6F] text-base sm:text-lg font-semibold max-w-[950px] mx-auto leading-relaxed space-y-1">
            ...
            <p>
              Here&apos;s what makes us different from other providers in Alaska.
            </p>
          </div>
        </div>

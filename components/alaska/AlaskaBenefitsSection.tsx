...
const financialBenefits = [
  {
    title: "Housing Protection Under FHA",
    description:
      "Under the Fair Housing Act, ESA letters help tenants request reasonable housing accommodations when standard pet policies or fees create barriers to living with their support animal.",
    icon: "/whomayqualifies-california_chronicworry.svg",
  },
  {
    title: "Exemption from Pet Rent & Deposits",
    description:
      "With legitimate ESA documentation, landlords generally cannot charge extra pet rent, pet fees, or pet deposits.",
    icon: "/california-benefits-workplaceconsideration.svg",
  },
  {
    title: "No Breed or Weight Restrictions",
    description:
      "Housing providers cannot deny an ESA based on breed or weight limits, provided the animal does not pose a direct physical safety risk.",
    icon: "/california-benefits-workplaceconsideration.svg",
  },
];
...
const emotionalBenefits = [
  {
    title: "Emotional Ease & Comfort",
    description:
      "The presence of an ESA may help some individuals feel more emotionally at ease in everyday environments and during challenging weather conditions.",
    icon: "/whomayqualifies-panicattack.svg",
  },
  {
    title: "Reduces Feelings of Isolation",
    description:
      "The presence of an ESA may help individuals feel less emotionally isolated during extended time spent at home in dark or winter months.",
    icon: "/california-benefits-strongersense.svg",
  },
  {
    title: "Anchors Daily Routines",
    description:
      "Having an ESA can help anchor daily routines and provide consistency during emotionally uncertain periods.",
    icon: "/california-benefits-strongersense.svg",
  },
];
...
export function AlaskaBenefitsSection() {
  return (
          ...
          <div className="order-1 lg:order-2 lg:col-span-5 relative flex justify-end items-stretch w-full">
            ...
            <div className="sm:hidden relative w-full aspect-[390/513]">
              <Image
                ...
                alt="Benefits Of Legitimate ESA Letter in Alaska Mobile View"
                fill
                priority
                unoptimized
            ...
            <div className="hidden sm:block lg:hidden relative w-full aspect-[834/1050]">
              <Image
                ...
                alt="Benefits Of Legitimate ESA Letter in Alaska Tablet View"
                fill
                priority
                unoptimized
                className="object-cover object-top"
            ...
            <div className="hidden lg:block relative w-full h-full lg:min-h-0 flex items-stretch">
              <Image
                ...
                alt="Benefits Of Legitimate ESA Letter in Alaska"
                fill
                priority
                unoptimized
          ...
          <div className="order-2 lg:order-1 lg:col-span-7 px-4 sm:px-6 lg:px-0 py-2 sm:py-4 lg:py-5 xl:py-12 pr-0 lg:pr-3 xl:pr-4 flex flex-col justify-center">
            ...
            <div className="mb-4 lg:mb-5 xl:mb-8">
              <h2 className="font-heading text-2xl sm:text-3xl lg:text-[29px] xl:text-[42px] font-bold text-[#1E3E47] leading-[1.16] tracking-tight mb-2 lg:mb-2.5">
                Benefits Of Legitimate ESA Letter in Alaska
              </h2>
              <p className="font-sans text-xs sm:text-sm lg:text-[12px] xl:text-base text-[#5F6B6F] font-medium leading-relaxed max-w-[520px]">
                A valid ESA letter issued by an Alaska-licensed mental health professional helps support housing-related accommodation requests under federal fair housing guidelines.
              </p>
            </div>

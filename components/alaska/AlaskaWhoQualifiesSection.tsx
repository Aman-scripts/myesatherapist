...
const conditions = [
  {
    title: "Anxiety & Seasonal Affective Stress",
    description: "Generalized anxiety or stress heightened by prolonged dark/cold winter periods.",
    icon: "/whomayqualifies-california_chronicworry.svg",
  },
  {
    title: "Depression & Burnout",
    description: "Persistent low mood, feelings of isolation, or lack of energy affecting daily routine.",
    icon: "/whomayqualifies-moodconditions.svg",
  },
  {
    title: "Post-Traumatic Stress (PTSD)",
    description: "Trauma-related stress responses requiring continuous emotional reassurance at home.",
    icon: "/whomayqualifies-california_posttrauma.svg",
  },
  {
    title: "Panic Attacks & Emotional Isolation",
    description: "Surges of intense distress or feelings of severe physical and emotional isolation.",
    icon: "/whomayqualifies-panicattack.svg",
  },
];

export function AlaskaWhoQualifiesSection() {
  return (
          ...
          <div className="order-1 lg:order-2 lg:col-span-5 relative flex justify-end items-stretch w-full">
            ...
            <div className="sm:hidden relative w-full aspect-[390/440]">
              <Image
                ...
                alt="Who May Qualify for an Emotional Support Animal in Alaska Mobile View"
                fill
                priority
                unoptimized
            ...
            <div className="hidden sm:block lg:hidden relative w-full aspect-[834/943]">
              <Image
                ...
                alt="Who May Qualify for an Emotional Support Animal in Alaska Tablet View"
                fill
                priority
                unoptimized
                className="object-cover object-top"
            ...
            <div className="hidden lg:block relative w-full h-full min-h-[360px]">
              <Image
                ...
                alt="Who May Qualify for an Emotional Support Animal in Alaska"
                fill
                priority
                unoptimized
          ...
          <div className="order-2 lg:order-1 lg:col-span-7 px-4 sm:px-6 lg:px-0 py-2 sm:py-4 lg:py-6 pr-0 lg:pr-2 xl:pr-4 flex flex-col justify-center">
            ...
            <div className="mb-4 lg:mb-4">
              <h2 className="font-heading text-2xl sm:text-3xl lg:text-[32px] xl:text-[42px] font-bold text-[#1E3E47] leading-[1.16] tracking-tight mb-2">
                Who May Qualify for an Emotional Support Animal in Alaska?
              </h2>
              <p className="font-sans text-xs sm:text-sm lg:text-[13px] xl:text-base text-[#5F6B6F] font-medium leading-[1.5] max-w-[540px]">
                Individuals suffering from mental health conditions that substantially impact day-to-day activities may qualify for an ESA evaluation. Clinicians determine eligibility aligned with DSM-5-TR criteria and federal Fair Housing Act standards.
              </p>
            </div>

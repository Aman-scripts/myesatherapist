...
const steps = [
  {
    ...
    description:
      "Complete a brief online assessment and schedule a confidential evaluation with an Alaska-licensed mental health clinician.",
  ...
  },
  {
    ...
    description:
      "Connect with your clinician via secure telehealth to evaluate your qualifying mental or emotional health condition under Fair Housing Act standards.",
  ...
  },
  {
    ...
    description:
      "If the clinician determines an ESA is clinically appropriate, you'll receive a signed ESA recommendation letter on official letterhead from an Alaska-licensed provider.",
...
const differentiators = [
  ...
  "Licensed Alaska mental health experts make all clinical decisions",
  "HIPAA-compliant, secure online platform for privacy and confidentiality",
];

export function AlaskaProcessSection() {
  const scrollToForm = () => {
    ...
    >
      <div className="max-w-[1260px] mx-auto">
        ...
        <div className="text-center max-w-[1050px] mx-auto mb-14 sm:mb-16">
          <h2 className="font-heading text-2xl sm:text-3xl lg:text-[40px] xl:text-[44px] font-bold text-[#1E3E47] leading-[1.18] tracking-tight mb-4 md:whitespace-nowrap"> How ESA Evaluation Works in Alaska </h2>
          <p className="font-sans text-sm sm:text-base lg:text-[16.5px] text-[#5F6B6F] font-medium leading-[1.65]">
            Our process is simple, secure, and compliant with Alaska state laws and federal Fair Housing Act guidelines.
          </p>
        </div>

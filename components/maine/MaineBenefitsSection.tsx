...
const financialBenefits = [
  {
    ...
    description:
      "An ESA letter in Maine helps eliminate extra charges for certain animals, making housing more affordable without additional pet-related fees.",
    icon: "/whomayqualifies-california_chronicworry.svg",
  },
  {
    title: "Lower Relocation Costs",
    description:
      "Access to a wider range of housing options reduces the need for repeated applications, deposits, and moving expenses caused by pet restrictions.",
    icon: "/california-benefits-workplaceconsideration.svg",
  },
  {
    title: "Fairer Damage Evaluations",
    description:
      "Since ESAs are recognized accommodations, tenants may experience more reasonable assessments and avoid inflated repair costs.",
    icon: "/california-benefits-workplaceconsideration.svg",
  },
];
...
const emotionalBenefits = [
  {
    ...
    description:
      "ESAs provide reassurance during stressful situations, helping individuals feel more relaxed and emotionally balanced.",
    icon: "/whomayqualifies-panicattack.svg",
  },
  {
    title: "Structured Daily Routine",
    description:
      "Caring for an ESA encourages consistency, supporting better sleep patterns, focus, and overall mental wellness.",
    icon: "/california-benefits-strongersense.svg",
  },
  {
    title: "Reduced Feelings of Isolation",
    description:
      "Constant companionship from an ESA helps individuals feel less alone and gradually become more comfortable in social situations.",
    icon: "/california-benefits-strongersense.svg",
  },
];
...
export function MaineBenefitsSection() {
  return (
          ...
          <div className="order-1 lg:order-2 lg:col-span-5 relative flex justify-end items-stretch w-full">
            ...
            <div className="sm:hidden relative w-full aspect-[390/513]">
              <Image
                ...
                alt="Benefits of Having an ESA Letter in Maine Mobile View"
                fill
                priority
                unoptimized
            ...
            <div className="hidden sm:block lg:hidden relative w-full aspect-[834/1050]">
              <Image
                ...
                alt="Benefits of Having an ESA Letter in Maine Tablet View"
                fill
                priority
                unoptimized
                className="object-cover object-top"
            ...
            <div className="hidden lg:block relative w-full h-full lg:min-h-0 flex items-stretch">
              <Image
                ...
                alt="Benefits of Having an ESA Letter in Maine"
                fill
                priority
                unoptimized
          ...
          <div className="order-2 lg:order-1 lg:col-span-7 px-4 sm:px-6 lg:px-0 py-2 sm:py-4 lg:py-5 xl:py-12 pr-0 lg:pr-3 xl:pr-4 flex flex-col justify-center">
            ...
            <div className="mb-4 lg:mb-5 xl:mb-8">
              ...
              <p className="font-sans text-xs sm:text-sm lg:text-[12px] xl:text-base text-[#5F6B6F] font-medium leading-relaxed max-w-[520px]">
                Explore how qualifying for an emotional support animal letter in Maine can improve your well-being and make daily life with your companion more manageable and rewarding.
              </p>
            </div>

...
const maineCities = [
  ...
  { name: "Saco", icon: "/sanfranciscofour.svg" },
];

export function MaineAvailableCitiesSection() {
  return (
      ...
      <div className="max-w-[1060px] mx-auto">
        ...
        <div className="text-center max-w-[840px] mx-auto mb-10 sm:mb-12 lg:mb-14">
          <h2 className="font-heading text-2xl sm:text-3xl lg:text-[40px] xl:text-[44px] font-bold text-[#1E3E47] leading-[1.2] tracking-tight">
            Available Everywhere in Maine
          </h2>
          <p className="font-sans text-xs sm:text-sm lg:text-[15px] text-[#5F6B6F] font-medium leading-relaxed mt-3 max-w-[760px] mx-auto">
            Our telehealth platform connects individuals across Maine with licensed mental health professionals. No matter where you live in the state—from Portland to Bangor—our confidential online services are designed to be accessible and convenient.
          </p>
        </div>

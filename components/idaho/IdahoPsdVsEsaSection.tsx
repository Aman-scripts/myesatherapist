...
const esaBullets = [
  "Offer emotional relief and companionship to individuals dealing with conditions like anxiety, depression, or PTSD.",
  "Do not need specialized or task-based training.",
  "Require a valid ESA letter from an Idaho-licensed mental health professional.",
...
const psdBullets = [
  ...
  "Given full public access rights to accompany handlers into offices, stores, and restaurants.",
];

export function IdahoPsdVsEsaSection() {
  return (
      ...
      <div className="max-w-[1080px] mx-auto">
        ...
        <div className="text-center max-w-[840px] mx-auto mb-10 sm:mb-12 lg:mb-14">
          <h2 className="font-heading text-2xl sm:text-3xl lg:text-[38px] xl:text-[42px] font-bold text-[#1E3E47] leading-[1.2] tracking-tight">
            ...
            <br className="hidden sm:inline" /> Support Animals in Idaho
          </h2>
          <p className="font-sans text-xs sm:text-sm lg:text-[15px] text-[#5F6B6F] font-medium leading-relaxed mt-3 max-w-[760px] mx-auto">
            In Idaho, it’s important to clearly distinguish between emotional support animals (ESAs) and psychiatric service dogs (PSDs). While both support individuals with mental health conditions, they differ significantly in legal coverage, training requirements, and access rights.
          </p>
        </div>

        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-5 xl:gap-8 mb-10 lg:mb-12">
          
          {/* Card 1: Emotional Support Animals (ESA) */}
          ...
          {/* Card 2: Psychiatric Service Dogs (PSD) */}
          <div className="bg-white rounded-[22px] sm:rounded-[26px] lg:rounded-[28px] border border-[#EAE5DC] shadow-[0_4px_20px_rgba(0,0,0,0.025)] flex flex-col sm:flex-row overflow-hidden">
            <div className="relative w-full sm:w-[32%] lg:w-[28%] xl:w-[34%] aspect-[4/3] sm:aspect-auto shrink-0 overflow-hidden">
              <Image

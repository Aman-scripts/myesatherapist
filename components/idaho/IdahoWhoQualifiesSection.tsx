...
const conditions = [
  {
    ...
    description: "Persistent feeling of being detached from reality.",
    icon: "/whomayqualifies-california_chronicworry.svg",
  },
  {
    title: "Excoriation Disorder",
    description: "Uncontrollable urge to pick skin affecting emotional state.",
    icon: "/whomayqualifies-panicattack.svg",
  },
  {
    title: "Selective Mutism",
    description: "Unable to speak in certain situations due to extreme social anxiety.",
    icon: "/whomayqualifies-california_posttrauma.svg",
  },
  {
    title: "Hoarding Disorder",
    description: "Difficulty letting go of items impacting home environment.",
    icon: "/whomayqualifies-moodconditions.svg",
  },
];

export function IdahoWhoQualifiesSection() {
  return (
          ...
          <div className="order-1 lg:order-2 lg:col-span-5 relative flex justify-end items-center w-full">
            ...
            <div className="sm:hidden relative w-full aspect-[390/440]">
              <Image
                ...
                alt="Who May Qualify for an ESA Letter in Idaho Mobile View"
                fill
                priority
                unoptimized
            ...
            <div className="hidden sm:block lg:hidden relative w-full aspect-[834/943]">
              <Image
                ...
                alt="Who May Qualify for an ESA Letter in Idaho Tablet View"
                fill
                priority
                unoptimized
                className="object-cover object-top"
            ...
            <div className="hidden lg:flex items-center justify-end w-full h-full">
              <div className="relative w-full max-h-[620px] aspect-[694/827] ml-auto">
                <Image
                  ...
                  alt="Who qualifies for Idaho ESA Letter"
                  fill
                  priority
                  unoptimized
          ...
          <div className="order-2 lg:order-1 lg:col-span-7 px-4 sm:px-6 lg:px-0 py-2 sm:py-4 lg:py-6 pr-0 lg:pr-2 xl:pr-4 flex flex-col justify-center">
            ...
            <div className="mb-4 lg:mb-4">
              ...
              <p className="font-sans text-xs sm:text-sm lg:text-[13px] xl:text-base text-[#5F6B6F] font-medium leading-[1.5] max-w-[540px]">
                When emotional or mental health challenges begin affecting daily life or overall functioning, individuals exploring how to obtain an ESA letter in Idaho typically start with a clinical assessment. While the list of conditions is endless, commonly reviewed conditions may include the following:
              </p>
            </div>

...
const features = [
  ...
  },
  {
    ...
    description:
      "When clinically appropriate, ESA letters are issued in compliance with applicable federal and Idaho state housing guidelines.",
  },
  {
    icon: "/whychoose-section-nationwide-access.svg",
    title: "Nationwide Access",
    description:
      "Telehealth evaluations available for individuals across Idaho and the United States, subject to clinician availability.",
  },
  {
...
export function IdahoWhyChooseUsSection() {
  return (

...
export function IdahoLawsSection() {
  return (
      ...
      <div className="max-w-[1060px] mx-auto">
        ...
        <div className="text-center max-w-[820px] mx-auto mb-8 sm:mb-10 lg:mb-12">
          <h2 className="font-heading text-2xl sm:text-3xl lg:text-[36px] xl:text-[40px] font-bold text-[#1E3E47] leading-[1.2] tracking-tight mb-3">
            Housing Accommodation Guidelines for Idaho Emotional Support Animals
          </h2>
          <p className="font-sans text-xs sm:text-sm lg:text-[14.5px] text-[#5F6B6F] font-medium leading-relaxed max-w-[760px] mx-auto">
            Requests for emotional support animals must be reviewed in line with federal fair housing laws applicable in Idaho. Housing providers are expected to evaluate accommodation requests promptly, fairly, and without bias.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-6 xl:gap-8 mb-10 lg:mb-12">
              ...
              <div className="space-y-4 flex-1">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="font-sans text-[11px] sm:text-[12px] lg:text-[12.5px] text-[#5F6B6F] font-medium leading-relaxed">
                      Even in properties with strict “no pet” policies, qualified Idaho residents can request reasonable accommodation under the Fair Housing Act (FHA). Landlords must consider ESA requests without discrimination.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="font-sans text-[11px] sm:text-[12px] lg:text-[12.5px] text-[#5F6B6F] font-medium leading-relaxed">
                      Because ESAs are not classified as pets under federal housing regulations, landlords generally cannot impose pet fees, pet rent, or deposits once a valid ESA letter from an Idaho-licensed professional is approved.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="font-sans text-[11px] sm:text-[12px] lg:text-[12.5px] text-[#5F6B6F] font-medium leading-relaxed">
                      Each ESA request must be assessed individually. Blanket restrictions on breed, size, or weight are not allowed unless the specific animal presents a direct risk or potential property damage.
                    </p>
                  </div>
                </div>
              </div>
          ...
          {/* Card 2: Housing Provider Roles & Responsibilities */}
          <div className="bg-white rounded-[20px] sm:rounded-[24px] lg:rounded-[26px] border border-[#EAE5DC] shadow-[0_4px_20px_rgba(0,0,0,0.025)] flex flex-col overflow-hidden">
            <div className="relative w-full aspect-[16/9] overflow-hidden shrink-0">
              <Image
              ...
              <div className="space-y-4 flex-1">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="font-sans text-[11px] sm:text-[12px] lg:text-[12.5px] text-[#5F6B6F] font-medium leading-relaxed">
                      Housing providers in Idaho are required to respond to ESA accommodation requests within a reasonable timeframe, basing decisions on fair housing laws rather than standard pet policies.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="font-sans text-[11px] sm:text-[12px] lg:text-[12.5px] text-[#5F6B6F] font-medium leading-relaxed">
                      Landlords may verify that the ESA letter is legitimate and issued by a licensed Idaho mental health professional. However, they cannot request detailed medical records or inquire about specific diagnoses.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="font-sans text-[11px] sm:text-[12px] lg:text-[12.5px] text-[#5F6B6F] font-medium leading-relaxed">
                      While accommodating an ESA, landlords can still enforce general rules related to safety, hygiene, and noise. If an animal poses a proven threat or causes serious damage, further action may be taken.
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="max-w-[840px] mx-auto bg-[#FCF6E8] rounded-[18px] sm:rounded-[22px] overflow-hidden flex items-stretch shadow-[0_4px_20px_rgba(0,0,0,0.02)]">
          ...
          <div className="p-4 sm:p-5 lg:p-6 flex-1">
            ...
            <p className="font-sans text-[11px] sm:text-xs lg:text-[12.5px] text-[#5F6B6F] font-medium leading-relaxed">
              Emotional support animals are protected specifically within housing under the Fair Housing Act in Idaho. They do not have public access rights in restaurants, retail stores, or public places like service animals under the ADA. Airlines also operate under independent policies following Air Carrier Access Act (ACAA) updates.
            </p>
          </div>
        </div>

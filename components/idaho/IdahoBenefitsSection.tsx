...
const financialBenefits = [
  {
    ...
    description:
      "Documented ESAs may be viewed differently by some insurers, which could reduce liability coverage costs in Idaho rentals.",
    icon: "/whomayqualifies-california_chronicworry.svg",
  },
  {
    title: "Reduced Deposits",
    description:
      "An ESA letter supports discussions with landlords, avoiding extra deposits typically required for pets in Idaho rentals.",
    icon: "/california-benefits-workplaceconsideration.svg",
  },
  {
    title: "No Extra Fees",
    description:
      "Tenants avoid ongoing pet processing or administrative fees that are frequently added to lease agreements.",
    icon: "/california-benefits-workplaceconsideration.svg",
  },
];
...
const emotionalBenefits = [
  {
    ...
    description:
      "Consistent interaction with an ESA gently regulates mood cycles, helping maintain emotional balance during daily stress.",
    icon: "/whomayqualifies-panicattack.svg",
  },
  {
    title: "Silent Comfort",
    description:
      "ESAs provide silent companionship, allowing individuals to process complex emotions safely without verbal expression.",
    icon: "/california-benefits-strongersense.svg",
  },
  {
    title: "Emotional Grounding",
    description:
      "During times of mental overload, having an ESA provides a steady emotional base that promotes personal resilience.",
    icon: "/california-benefits-strongersense.svg",
  },
];
...
export function IdahoBenefitsSection() {
  return (
          ...
          <div className="order-1 lg:order-2 lg:col-span-5 relative flex justify-end items-stretch w-full">
            ...
            <div className="sm:hidden relative w-full aspect-[390/513]">
              <Image
                ...
                alt="Benefits of Having an ESA Letter in Idaho Mobile View"
                fill
                priority
                unoptimized
            ...
            <div className="hidden sm:block lg:hidden relative w-full aspect-[834/1050]">
              <Image
                ...
                alt="Benefits of Having an ESA Letter in Idaho Tablet View"
                fill
                priority
                unoptimized
                className="object-cover object-top"
            ...
            <div className="hidden lg:block relative w-full h-full lg:min-h-0 flex items-stretch">
              <Image
                ...
                alt="Benefits of Having an ESA Letter in Idaho"
                fill
                priority
                unoptimized
          ...
          <div className="order-2 lg:order-1 lg:col-span-7 px-4 sm:px-6 lg:px-0 py-2 sm:py-4 lg:py-5 xl:py-12 pr-0 lg:pr-3 xl:pr-4 flex flex-col justify-center">
            ...
            <div className="mb-4 lg:mb-5 xl:mb-8">
              ...
              <p className="font-sans text-xs sm:text-sm lg:text-[12px] xl:text-base text-[#5F6B6F] font-medium leading-relaxed max-w-[520px]">
                Look at how an ESA letter from Idaho could improve your well-being and make your daily routine with your emotional support animal easy and manageable.
              </p>
            </div>

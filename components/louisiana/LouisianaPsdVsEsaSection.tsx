...
const esaBullets = [
  "Provide companionship and emotional relief for conditions like anxiety, depression, and PTSD.",
  "No task-specific training required; valid ESA letter needed from a Louisiana clinician.",
  "Protected under the Fair Housing Act (FHA) for housing accommodations.",
  "Approved ESA housing excludes pet rent or additional security deposits.",
];

const psdBullets = [
  "Specially trained to perform defined tasks directly related to a psychiatric disability.",
  "Protected under the Americans with Disabilities Act (ADA).",
  "Granted full public access rights in workplaces, restaurants, retail stores, and public spaces.",
];

export function LouisianaPsdVsEsaSection() {
  return (
      ...
      <div className="max-w-[1080px] mx-auto">
        ...
        <div className="text-center max-w-[840px] mx-auto mb-10 sm:mb-12 lg:mb-14">
          <h2 className="font-heading text-2xl sm:text-3xl lg:text-[38px] xl:text-[42px] font-bold text-[#1E3E47] leading-[1.2] tracking-tight">
            ...
            <br className="hidden sm:inline" /> Support Animals in Louisiana
          </h2>
          <p className="font-sans text-xs sm:text-sm lg:text-[15px] text-[#5F6B6F] font-medium leading-relaxed mt-3 max-w-[760px] mx-auto">
            In Louisiana, it&apos;s important to understand the difference between Psychiatric Service Dogs (PSDs) and Emotional Support Animals (ESAs). Each serves a distinct role and has different legal protections.
          </p>
        </div>

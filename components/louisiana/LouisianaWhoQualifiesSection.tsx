...
const conditions = [
  {
    ...
    description: "Persistent fear and worry interfering with daily functioning.",
    icon: "/whomayqualifies-california_chronicworry.svg",
  },
  {
    title: "Major Depressive Disorder",
    description: "Ongoing sadness, low motivation affecting productivity.",
    icon: "/whomayqualifies-panicattack.svg",
  },
  {
    title: "Post-Traumatic Stress Disorder",
    description: "Trauma-related flashbacks causing excessive sadness and distress.",
    icon: "/whomayqualifies-california_posttrauma.svg",
  },
  {
    title: "Bipolar Disorder",
    description: "Extreme mood shifts, emotional instability, creating problems in daily life.",
    icon: "/whomayqualifies-moodconditions.svg",
  },
];

export function LouisianaWhoQualifiesSection() {
  return (
          ...
          <div className="order-1 lg:order-2 lg:col-span-5 relative flex justify-end items-center w-full">
            ...
            <div className="sm:hidden relative w-full aspect-[390/440]">
              <Image
                ...
                alt="Who May Qualify for an ESA Letter in Louisiana Mobile View"
                fill
                priority
                unoptimized
            ...
            <div className="hidden sm:block lg:hidden relative w-full aspect-[834/943]">
              <Image
                ...
                alt="Who May Qualify for an ESA Letter in Louisiana Tablet View"
                fill
                priority
                unoptimized
                className="object-cover object-top"
            ...
            <div className="hidden lg:flex items-center justify-end w-full h-full">
              <div className="relative w-full max-h-[620px] aspect-[694/827] ml-auto">
                <Image
                  ...
                  alt="Who qualifies for Louisiana ESA Letter"
                  fill
                  priority
                  unoptimized
          ...
          <div className="order-2 lg:order-1 lg:col-span-7 px-4 sm:px-6 lg:px-0 py-2 sm:py-4 lg:py-6 pr-0 lg:pr-2 xl:pr-4 flex flex-col justify-center">
            ...
            <div className="mb-4 lg:mb-4">
              ...
              <p className="font-sans text-xs sm:text-sm lg:text-[13px] xl:text-base text-[#5F6B6F] font-medium leading-[1.5] max-w-[540px]">
                People living in Louisiana suffering from mental health issues interfering with daily life can get themselves assessed. This helps determine the need for an emotional support animal and whether an ESA could offer therapeutic benefits. During this evaluation, licensed clinicians in Louisiana consider several conditions, including:
              </p>
            </div>

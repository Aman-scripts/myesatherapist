  ...
  const steps = [
    {
      ...
      description:
        "Choose a suitable date and time to connect with a Louisiana-licensed mental health professional.",
      icon: "/process-step-1-schedule.svg",
    },
    {
      number: "02",
      title: "Confidential Clinical Evaluation",
      subtitle: "30-Day Therapeutic Relationship",
      description:
        "At your scheduled appointment, meet with the clinician via secure video/audio session. Under Louisiana's House Bill 407, the provider establishes a 30-day therapeutic relationship (minimum two consultations) before issuing documentation.",
    ...
    },
    {
      ...
      description:
        "After the assessment, if an ESA recommendation is deemed clinically appropriate, your official letter will be prepared and securely delivered via email.",
      ...
      <div className="max-w-[1060px] mx-auto">
        ...
        <div className="text-center max-w-[840px] mx-auto mb-10 sm:mb-12 lg:mb-14">
          <h2 className="font-heading text-2xl sm:text-3xl lg:text-[40px] xl:text-[44px] font-bold text-[#1E3E47] leading-[1.2] tracking-tight">
            How ESA Evaluation Process Works in Louisiana
          </h2>
          <p className="font-sans text-xs sm:text-sm lg:text-[15px] text-[#5F6B6F] font-medium leading-relaxed mt-3 max-w-[760px] mx-auto">
            Louisiana residents can complete a professional ESA evaluation supervised by a licensed clinician. The process is clear, simple, and fully adheres to the HB-407 Support and Service Animal Integrity Act of Louisiana.
          </p>
        </div>
        ...
        <div className="bg-[#FAF7F2] rounded-[20px] border border-[#EAE5DC] p-5 sm:p-6 text-center max-w-[900px] mx-auto">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-left">
            ...
            <div className="flex items-center gap-2.5">
              ...
              <span className="font-sans text-xs sm:text-[13px] font-semibold text-[#1E3E47]">
                Secure telehealth consultations following privacy standards.
              </span>
            </div>
            <div className="flex items-center gap-2.5">
              <div className="w-4.5 h-4.5 rounded-full bg-[#184F59] text-white flex items-center justify-center shrink-0">
            ...
            <div className="flex items-center gap-2.5">
              ...
              <span className="font-sans text-xs sm:text-[13px] font-semibold text-[#1E3E47]">
                ESA documentation issued only after independent clinical determination.
              </span>
            </div>
          </div>
        </div>

...
const steps = [
  {
    ...
    description:
      "Choose a convenient date and time to connect with a Louisiana-licensed mental health professional.",
    offsetClass: "md:translate-y-0",
  },
  {
    number: "02",
    icon: "/californina-esa-evalutation_clinicalevaluation.svg",
    title: "Clinical Evaluation & 30-Day Relationship",
    description:
      "Join a confidential video or phone session. Under Louisiana HB 407, your clinician conducts a comprehensive evaluation and establishes a 30-day therapeutic relationship.",
  ...
  },
  {
    ...
    description:
      "Following the required clinical process, your provider renders an independent determination. If appropriate, your official ESA letter is issued electronically.",
...
const differentiators = [
  ...
  "Evaluations conducted by licensed mental health professionals in Louisiana.",
  "Secure telehealth consultations adhering to HIPAA privacy standards.",
  "Full compliance with Louisiana House Bill 407 regulations.",
];

export function LouisianaProcessSection() {
  const scrollToForm = () => {
    ...
    >
      <div className="max-w-[1260px] mx-auto">
        ...
        <div className="text-center max-w-[1050px] mx-auto mb-14 sm:mb-16">
          <h2 className="font-heading text-2xl sm:text-3xl lg:text-[40px] xl:text-[44px] font-bold text-[#1E3E47] leading-[1.18] tracking-tight mb-4 md:whitespace-nowrap"> How ESA Evaluation Process Works in Louisiana? </h2>
          <p className="font-sans text-sm sm:text-base lg:text-[16.5px] text-[#5F6B6F] font-medium leading-[1.65]">
            Louisiana residents can complete a professional ESA evaluation supervised by a licensed clinician. The process is clear, simple, and adheres to House Bill 407 guidelines.
          </p>
        </div>
        ...
        <div className="bg-[#FAF5EB] rounded-[32px] sm:rounded-[36px] border border-[#EFE8DC] p-8 sm:p-10 lg:p-12 max-w-[920px] mx-auto shadow-xs">
          <h3 className="font-heading text-xl sm:text-2xl lg:text-[28px] xl:text-3xl font-bold text-[#1E3E47] text-center mb-8 md:whitespace-nowrap">
            Why Louisiana Residents Choose Our ESA Letter Process?
          </h3>

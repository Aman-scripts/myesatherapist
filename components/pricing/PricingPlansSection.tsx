...
export function PricingPlansSection() {
  return (
    <section id="plans" className="py-16 sm:py-20 lg:py-24 bg-[#FAF7F2] relative z-10 overflow-visible">
      <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8 space-y-20 lg:space-y-24">
        {/* ==================================================== */}
        {/* SECTION 1: Emotional Support Animal                  */}
        {/* ==================================================== */}
        <div className="flex flex-col items-center">
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-6 lg:gap-8 w-full max-w-[660px]">
        ...
        {/* ==================================================== */}
        {/* SECTION 2: Psychiatric Service Dog                  */}
        {/* ==================================================== */}
        <div className="flex flex-col items-center">
          {/* Heading */}
          <div className="text-center max-w-[709px] mx-auto mb-10 sm:mb-14 space-y-3">
          ...
          {/* Pricing Cards Container */}
          <div className="flex flex-col md:flex-row items-center justify-center gap-6 lg:gap-8 w-full max-w-[660px]">
            {/* 1. Starter Plan Card: PSD Letter */}
            <div className="w-full sm:w-[300px] min-h-[450px] bg-white rounded-[24px] border border-[#E1E1E1] p-7 sm:p-8 shadow-[0px_4px_8px_-2px_rgba(0,0,0,0.1)] flex flex-col justify-between shrink-0">
              <div className="space-y-4">
                {/* Title & Description */}
                <div>
                  <h3 className="font-heading text-[20px] font-bold text-[#2E5A66] leading-[28px]">
                  ...
                  <p className="text-[12px] text-[#666666] font-semibold leading-[20px] font-sans mt-1 min-h-[60px]">
                    Psychiatric Service Dog recommendation letter from a licensed professional, supporting broader rights under the ADA.
                  </p>
                </div>
            ...
            {/* 2. Highlight Frame Card: PSD Letter + ID Card */}
            <div className="w-full sm:w-[308px] min-h-[522px] rounded-[28px] bg-[#E8B92C] pt-2.5 px-1 pb-1 shadow-[0px_8px_18px_rgba(0,0,0,0.1),0px_33px_33px_rgba(0,0,0,0.09),0px_73px_44px_rgba(0,0,0,0.05),0px_130px_52px_rgba(0,0,0,0.01)] flex flex-col items-center shrink-0">
              <div className="text-center text-[#2E5A66] text-[14px] font-bold tracking-[0.08em] uppercase pb-2 font-sans">
                BEST VALUE
              </div>
              ...
              <div className="w-full bg-white rounded-[24px] p-7 sm:p-8 shadow-[0px_2px_4px_-2px_rgba(0,0,0,0.12)] flex flex-col justify-between min-h-[483px] flex-1">
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-[12px] text-[#666666] font-semibold leading-[20px] font-sans mt-1 min-h-[60px]">
                      Everything in the PSD Letter package, plus an official PSD ID card for clear identification of your psychiatric service dog.
                    </p>
                  </div>

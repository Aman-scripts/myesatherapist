...
const steps = [
  {
    ...
    description: "Schedule a consultation with a Montana-licensed mental health professional to establish the required 30-day clinical relationship under Montana HB 703.",
  ...
  },
  {
    ...
    description: "Complete confidential telehealth sessions over 30 days while your mental health history and emotional support animal needs are evaluated.",
  ...
  },
  {
    ...
    description: "Upon meeting clinical criteria after the 30-day period, your official HB 703–compliant Montana ESA letter is issued.",
    offsetClass: "md:translate-y-16 lg:translate-y-24",
  }
];

const differentiators = [
  "Full compliance with Montana HB 703 30-day provider relationship rules.",
  "Evaluations conducted by licensed mental health professionals in Montana.",
...
export function MontanaProcessSection() {
  const scrollToForm = () => {
      ...
      <div className="max-w-[1260px] mx-auto">
        ...
        <div className="text-center max-w-[1050px] mx-auto mb-14 sm:mb-16">
          <h2 className="font-heading text-2xl sm:text-3xl lg:text-[40px] xl:text-[44px] font-bold text-[#1E3E47] leading-[1.18] tracking-tight mb-4 md:whitespace-nowrap">
            How ESA Letter Process Works in Montana?
          </h2>
          <p className="font-sans text-sm sm:text-base lg:text-[16.5px] text-[#5F6B6F] font-medium leading-[1.65]">
            We connect Montana residents with licensed mental health professionals for personalized emotional wellness assessments.
          </p>
        </div>
        ...
        <div className="bg-[#FAF5EB] rounded-[32px] sm:rounded-[36px] border border-[#EFE8DC] p-8 sm:p-10 lg:p-12 max-w-[920px] mx-auto shadow-xs">
          <h3 className="font-heading text-xl sm:text-2xl lg:text-[28px] xl:text-3xl font-bold text-[#1E3E47] text-center mb-8 md:whitespace-nowrap">
            Why Montana Residents Choose Our ESA Letter Process?
          </h3>

...
const financialBenefits = [
  {
    ...
    description: "In Minnesota, even in localities with no-pet rules, anyone can ask for reasonable housing accommodations in order to live with an ESA.",
    icon: "/whomayqualifies-california_chronicworry.svg",
  },
  {
    title: "Avoid Additional Pet-Related Fees",
    description: "Once proper ESA documentation is approved, Minnesota landlords are prohibited from imposing pet rent, pet deposits, or associated pet costs.",
    icon: "/california-benefits-workplaceconsideration.svg",
  },
  {
    title: "No Breed, Size, or Weight Restrictions",
    description: "A recognized emotional support animal in Minnesota is normally not subject to breed, size, or weight restrictions from housing providers.",
    icon: "/california-benefits-workplaceconsideration.svg",
  }
];
...
const emotionalBenefits = [
  {
    ...
    description: "For many people living in Minnesota, an ESA could ease stress and anxiety-provoking thoughts and help lead a positive life ahead.",
    icon: "/whomayqualifies-panicattack.svg",
  },
  {
    title: "Supports Emotional Balance",
    description: "Regular companionship from an ESA can provide comfort and reassurance, helping promote more consistent emotional stability.",
    icon: "/california-benefits-strongersense.svg",
  },
  {
    title: "Builds Routine and Sense of Purpose",
    description: "Caring for an animal encourages daily structure, generates a sense of responsibility, and creates a deeper feeling of purpose.",
    icon: "/california-benefits-strongersense.svg",
  }
];
...
export function MinnesotaBenefitsSection() {
  return (
          ...
          <div className="order-1 lg:order-2 lg:col-span-5 relative flex justify-end items-stretch w-full">
            <div className="sm:hidden relative w-full aspect-[390/513]">
              <Image
                ...
                alt="Benefits of Having an ESA Letter in Minnesota Mobile View"
                fill
                priority
                unoptimized
            ...
            <div className="hidden sm:block lg:hidden relative w-full aspect-[834/1050]">
              <Image
                ...
                alt="Benefits of Having an ESA Letter in Minnesota Tablet View"
                fill
                priority
                unoptimized
                className="object-cover object-top"
            ...
            <div className="hidden lg:block relative w-full h-full lg:min-h-0 flex items-stretch">
              <Image
                ...
                alt="Benefits of Having an ESA Letter in Minnesota"
                fill
                priority
                unoptimized
          ...
          <div className="order-2 lg:order-1 lg:col-span-7 px-4 sm:px-6 lg:px-0 py-2 sm:py-4 lg:py-5 xl:py-12 pr-0 lg:pr-3 xl:pr-4 flex flex-col justify-center">
            ...
            <div className="mb-4 lg:mb-5 xl:mb-8">
              ...
              <p className="font-sans text-xs sm:text-sm lg:text-[12px] xl:text-base text-[#5F6B6F] font-medium leading-relaxed max-w-[520px]">
                Look at the ways in which an emotional support animal letter in Minnesota can help

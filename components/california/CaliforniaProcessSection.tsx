...
const steps = [
  {
    ...
    description:
      "Create an account and schedule a telehealth appointment with a California-licensed mental health professional. This begins the required 30-day provider relationship under AB 468.",
  ...
  },
  {
    ...
    description:
      "If the clinician determines that an ESA is appropriate after the 30-day requirement, a compliant ESA letter is issued and delivered securely.",
...
export function CaliforniaProcessSection() {
  const scrollToForm = () => {
  ...
  return (
    ...
    >
      <div className="max-w-[1260px] mx-auto">
        ...
        {/* Header matching Figma Frame 1000012002 */}
        <div className="text-center max-w-[820px] mx-auto mb-14 sm:mb-16">
          <h2 className="font-heading text-3xl sm:text-4xl lg:text-[44px] font-bold text-[#1E3E47] leading-[1.18] tracking-tight mb-4">
            How the California ESA Evaluation
          ...
          <p className="font-sans text-sm sm:text-base lg:text-[16.5px] text-[#5F6B6F] font-medium leading-[1.65]">
            Our platform helps California residents connect with licensed mental health professionals for
            ESA evaluations conducted through secure telehealth, in accordance with California&apos;s AB 468 requirements.
          </p>
        </div>

        {/* 3 Step Cards Grid - Same size cards with staggered vertical offsets matching screenshot */}

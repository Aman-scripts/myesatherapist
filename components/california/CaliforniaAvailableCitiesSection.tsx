...
const californiaCities = [
  ...
  { name: "Los Angeles", icon: "/losangelestwo.svg" },
  { name: "Los Angeles", icon: "/losangelesfour.svg" },
  { name: "Los Angeles", icon: "/losangelesthree.svg" },
  { name: "San Francisco", icon: "/sanfranciscotwo.svg" },
  { name: "San Francisco", icon: "/sanfranciscothree.svg" },
  { name: "San Francisco", icon: "/sanfranciscofour.svg" },
];

export function CaliforniaAvailableCitiesSection() {
  return (
      ...
      <div className="max-w-[1060px] mx-auto">
        ...
        <div className="text-center max-w-[840px] mx-auto mb-10 sm:mb-12 lg:mb-14">
          <h2 className="font-heading text-2xl sm:text-3xl lg:text-[40px] xl:text-[44px] font-bold text-[#1E3E47] leading-[1.2] tracking-tight">
            Available Everywhere in California
          </h2>
          <p className="font-sans text-xs sm:text-sm lg:text-[15px] text-[#5F6B6F] font-medium leading-relaxed mt-3 max-w-[760px] mx-auto">
            ...
            across all 482 cities and 58 counties in California, from San Diego all the way up to Eureka.
          </p>
        </div>

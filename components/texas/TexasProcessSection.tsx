...
const steps = [
  ...
  },
  {
    ...
    description:
      "A licensed mental health professional licensed to practice in Texas reviews your assessment during a telehealth consultation.",
  ...
  },
  {
    ...
    description:
      "If clinically recommended, receive your official ESA documentation compliant with the Texas Fair Housing Act and federal guidelines.",
    icon: "/howitworks-cardthree.svg",
  },
];

export function TexasProcessSection() {
  return (
      ...
      <div className="max-w-[1240px] mx-auto">
        ...
        <div className="text-center max-w-[840px] mx-auto mb-10 sm:mb-12 lg:mb-16">
          <h2 className="font-heading text-2xl sm:text-3xl lg:text-[40px] xl:text-[44px] font-bold text-[#1E3E47] leading-[1.2] tracking-tight">
            How to Request an ESA Letter in Texas?
          </h2>
          <p className="font-sans text-xs sm:text-sm lg:text-[15px] text-[#5F6B6F] font-medium leading-relaxed mt-3 max-w-[760px] mx-auto">
            Our telehealth evaluation process is designed to be straightforward, secure, and fully compliant with Texas state laws and federal Fair Housing Act regulations.
          </p>
        </div>
        ...
        <div className="mt-10 sm:mt-12 max-w-[960px] mx-auto bg-[#FAF7F2] rounded-[16px] p-4 sm:p-5 border border-[#EAE5DC] shadow-xs flex items-center gap-4">
          ...
          <p className="font-sans text-xs sm:text-sm text-[#5F6B6F] font-medium leading-relaxed">
            <strong className="text-[#1E3E47]">Important Note:</strong> ESA letters issued by My ESA Therapist are written by clinicians licensed to practice in Texas and strictly follow established telehealth and mental health evaluation standards.
          </p>
        </div>

...
const conditions = [
  {
    title: "Generalized Anxiety & Stress",
    description: "Persistent worry affecting daily routines and peace of mind.",
    icon: "/whomayqualifies-california_chronicworry.svg",
  },
  {
    title: "Depression & Mood Disorders",
    description: "Loss of motivation, sadness, and emotional fatigue.",
    icon: "/whomayqualifies-moodconditions.svg",
  },
  {
    title: "Post-Traumatic Stress (PTSD)",
    description: "Trauma-induced anxiety, nightmares, and hypervigilance.",
    icon: "/whomayqualifies-california_posttrauma.svg",
  },
  {
    title: "Panic Disorder & Agoraphobia",
    description: "Sudden panic attacks and fear of overwhelming environments.",
    icon: "/whomayqualifies-panicattack.svg",
  },
];

export function TexasWhoQualifiesSection() {
  return (
          ...
          <div className="order-1 lg:order-2 lg:col-span-5 relative flex justify-end items-stretch w-full">
            ...
            <div className="sm:hidden relative w-full aspect-[390/440]">
              <Image
                ...
                alt="Who May Qualify for an ESA Letter in Texas Mobile View"
                fill
                priority
                unoptimized
            ...
            <div className="hidden sm:block lg:hidden relative w-full aspect-[834/943]">
              <Image
                ...
                alt="Who May Qualify for an ESA Letter in Texas Tablet View"
                fill
                priority
                unoptimized
                className="object-cover object-top"
            ...
            <div className="hidden lg:block relative w-full h-full min-h-[360px]">
              <Image
                ...
                alt="Who qualifies for Texas ESA Letter"
                fill
                priority
                unoptimized

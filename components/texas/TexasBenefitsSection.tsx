...
const financialBenefits = [
  {
    title: "Protection From Pet Fees & Monthly Pet Rent",
    description:
      "Under the Fair Housing Act and Texas Property Code, landlords cannot charge pet deposits, pet fees, or monthly pet rent for a verified emotional support animal.",
    icon: "/whomayqualifies-california_chronicworry.svg",
  },
  {
    title: "Exemption From No-Pet Restrictions",
    description:
      "An ESA letter allows tenants with qualifying mental health conditions to live in rental properties that otherwise enforce strict no-pet rules.",
    icon: "/california-benefits-workplaceconsideration.svg",
  },
  {
    title: "Protection From Breed & Weight Limits",
    description:
      "Housing providers in Texas cannot restrict emotional support animals based on breed or weight, as long as the animal does not pose a direct threat to safety.",
    icon: "/california-benefits-workplaceconsideration.svg",
  },
];
...
const emotionalBenefits = [
  {
    ...
    description:
      "Caring for an emotional support animal promotes consistent routines such as walking, feeding, and interaction, providing structure and daily stability.",
    icon: "/whomayqualifies-panicattack.svg",
  },
  {
    title: "Emotional Grounding During Overwhelming Moments",
    description:
      "An ESA provides a comforting presence during anxiety, stress, or panic episodes, helping individuals refocus and regain balance.",
    icon: "/california-benefits-strongersense.svg",
  },
  {
    title: "Strengthened Sense of Purpose & Connection",
    description:
      "The companion relationship with an ESA reduces feelings of loneliness, increases motivation, and supports overall emotional resilience.",
    icon: "/california-benefits-strongersense.svg",
  },
];
...
export function TexasBenefitsSection() {
  return (
          ...
          <div className="order-1 lg:order-2 lg:col-span-5 relative flex justify-end items-stretch w-full">
            ...
            <div className="sm:hidden relative w-full aspect-[390/513]">
              <Image
                ...
                alt="Benefits of Having an ESA Letter in Texas Mobile View"
                fill
                priority
                unoptimized
            ...
            <div className="hidden sm:block lg:hidden relative w-full aspect-[834/1050]">
              <Image
                ...
                alt="Benefits of Having an ESA Letter in Texas Tablet View"
                fill
                priority
                unoptimized
                className="object-cover object-top"
            ...
            <div className="hidden lg:block relative w-full h-full lg:min-h-0 flex items-stretch">
              <Image
                ...
                alt="Benefits of Having an ESA Letter in Texas"
                fill
                priority
                unoptimized
          ...
          <div className="order-2 lg:order-1 lg:col-span-7 px-4 sm:px-6 lg:px-0 py-2 sm:py-4 lg:py-5 xl:py-12 pr-0 lg:pr-3 xl:pr-4 flex flex-col justify-center">
            ...
            <div className="mb-4 lg:mb-5 xl:mb-8">
              ...
              <p className="font-sans text-xs sm:text-sm lg:text-[12px] xl:text-base text-[#5F6B6F] font-medium leading-relaxed max-w-[520px]">
                Discover how a legitimate emotional support animal letter in Texas can help individuals with qualifying mental health conditions live comfortably with their ESAs under state and federal housing protections.
              </p>
            </div>

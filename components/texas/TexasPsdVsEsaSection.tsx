...
const esaBullets = [
  "Provide emotional comfort and companionship for individuals with mental health conditions.",
  "No specialized task training required; valid ESA letter needed for housing accommodations.",
  "Protected under the Fair Housing Act and Texas Property Code Chapter 301.",
  "Approved ESA housing excludes pet deposits, pet fees, or monthly pet rent.",
];

const psdBullets = [
  "Specially trained dogs performing specific tasks supporting psychiatric disabilities.",
  "Legally recognized under the ADA and Texas Human Resources Code Chapter 121.",
  "Granted full public access rights in restaurants, stores, workplaces, and hotels.",
];
      ...
      <div className="max-w-[1080px] mx-auto">
        ...
        <div className="text-center max-w-[840px] mx-auto mb-10 sm:mb-12 lg:mb-14">
          ...
          <p className="font-sans text-xs sm:text-sm lg:text-[15px] text-[#5F6B6F] font-medium leading-relaxed mt-3 max-w-[760px] mx-auto">
            Understanding distinctions between psychiatric service dogs (PSDs) and emotional support animals (ESAs) in Texas is crucial. While both assist individuals with mental health needs, their training requirements, public access rights, and legal protections under Texas law differ significantly.
          </p>
        </div>
        ...
        <div className="max-w-[840px] mx-auto bg-[#FCF6E8] rounded-[18px] sm:rounded-[22px] overflow-hidden flex items-stretch shadow-[0_4px_20px_rgba(0,0,0,0.02)]">
          ...
          <div className="p-4 sm:p-5 lg:p-6 flex-1">
            <h3 className="font-heading text-sm sm:text-base lg:text-[17px] font-bold text-[#1E3E47] mb-1.5 leading-snug">
              Getting a Psychiatric Service Dog in Texas
            </h3>
            <p className="font-sans text-[11px] sm:text-xs lg:text-[12.5px] text-[#5F6B6F] font-medium leading-relaxed">
              In Texas, documentation from a qualified mental health professional confirming a psychiatric disability is standard for individuals requesting a PSD. The dog must be individually trained to perform specific tasks directly mitigating the disability. Under Texas Human Resources Code § 121.006, fraudulently claiming an untrained animal as a service animal carries legal penalties up to a $1,000 fine and community service.
            </p>
          </div>
        </div>

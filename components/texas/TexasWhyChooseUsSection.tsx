...
const features = [
  {
    ...
    description:
      "Evaluations are conducted by independent Texas-licensed mental health professionals authorized to assess ESA eligibility.",
  },
  {
    icon: "/whychoose-section-secure-thealth.svg",
    title: "Secure Telehealth Platform",
    description:
      "HIPAA-compliant systems ensure your medical and personal information remains strictly confidential and protected.",
  },
  {
    icon: "/whychoose-section-clinical-integrity.svg",
    title: "Clinical Integrity First",
    description:
      "We do not guarantee ESA approval. Recommendations are based solely on professional clinical evaluation and judgment.",
  },
  {
    icon: "/whychoose-section-legimate-documentation.svg",
    title: "Legitimate ESA Documentation",
    description:
      "When clinically appropriate, ESA letters are issued in full compliance with the Texas Fair Housing Act and federal guidelines.",
  },
  {
    icon: "/whychoose-section-nationwide-access.svg",
    title: "Statewide Texas Access",
    description:
      "Telehealth evaluations available for individuals residing anywhere across Texas.",
  },
  {
    icon: "/whychoose-section-transparent-process.svg",
    title: "Transparent Process",
    description:
      "Clear steps, clear expectations, and honest clinical recommendations with no misleading claims.",
  },
];

export function TexasWhyChooseUsSection() {
  return (
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-14 lg:mb-20 space-y-2.5">
          ...
          <div className="text-[#5F6B6F] text-base sm:text-lg font-semibold max-w-[950px] mx-auto leading-relaxed space-y-1">
            <p>
              We simplify online emotional support animal evaluations while maintaining efficiency, clinical integrity, and legal compliance.
            </p>
            <p>

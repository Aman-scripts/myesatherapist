...
const features = [
  {
    ...
    description:
      "ESA Evaluations are conducted by independent US licensed mental health professionals authorized to assess ESA eligibility.",
  },
  {
...
export function MarylandWhyChooseUsSection() {
  return (

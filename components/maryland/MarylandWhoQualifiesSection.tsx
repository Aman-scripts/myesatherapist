...
const conditions = [
  {
    ...
    description: "Frequent mood swings and intense interpersonal stress.",
    icon: "/whomayqualifies-california_chronicworry.svg",
  },
  {
    title: "Obsessive-Compulsive Disorder",
    description: "Intrusion of unwanted thoughts relieved by compulsive actions.",
    icon: "/whomayqualifies-panicattack.svg",
  },
  {
    title: "Social Anxiety Disorder",
    description: "Intense fear of judgment or public scrutiny.",
    icon: "/whomayqualifies-california_posttrauma.svg",
  },
  {
    title: "Generalized Anxiety Disorder",
    description: "Persistent worry affecting day-to-day routines.",
    icon: "/whomayqualifies-moodconditions.svg",
  },
];

export function MarylandWhoQualifiesSection() {
  return (
          ...
          <div className="order-1 lg:order-2 lg:col-span-5 relative flex justify-end items-center w-full">
            ...
            <div className="sm:hidden relative w-full aspect-[390/440]">
              <Image
                ...
                alt="Who May Qualify for an ESA Letter in Maryland Mobile View"
                fill
                priority
                unoptimized
            ...
            <div className="hidden sm:block lg:hidden relative w-full aspect-[834/943]">
              <Image
                ...
                alt="Who May Qualify for an ESA Letter in Maryland Tablet View"
                fill
                priority
                unoptimized
                className="object-cover object-top"
            ...
            <div className="hidden lg:flex items-center justify-end w-full h-full">
              <div className="relative w-full max-h-[620px] aspect-[694/827] ml-auto">
                <Image
                  ...
                  alt="Who qualifies for Maryland ESA Letter"
                  fill
                  priority
                  unoptimized
          ...
          <div className="order-2 lg:order-1 lg:col-span-7 px-4 sm:px-6 lg:px-0 py-2 sm:py-4 lg:py-6 pr-0 lg:pr-2 xl:pr-4 flex flex-col justify-center">
            <div className="mb-4 lg:mb-4">
              ...
              <p className="font-sans text-xs sm:text-sm lg:text-[13px] xl:text-base text-[#5F6B6F] font-medium leading-[1.5] max-w-[540px]">
                Maryland residents who experience mental health challenges that affect daily activities may seek an evaluation from a licensed mental health professional. A clinical assessment helps determine if an emotional support animal could provide therapeutic relief. Common conditions evaluated by Maryland clinicians include:
              </p>
            </div>

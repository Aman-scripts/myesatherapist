...
const financialBenefits = [
  {
    ...
    description:
      "In Maryland, individuals may request reasonable housing accommodations to live with their emotional support animals even in localities that enforce no pet policies.",
    icon: "/whomayqualifies-california_chronicworry.svg",
  },
  {
    title: "Avoid Extra Pet Related Costs",
    description:
      "Since ESAs are not categorized as normal pets in Maryland under fair housing rules, accommodation providers generally cannot charge pet rent, deposits, or similar fees.",
    icon: "/california-benefits-workplaceconsideration.svg",
  },
  {
    title: "No Breed, Weight, or Size Limits",
    description:
      "Housing providers in Maryland typically cannot apply breed, weight or size restrictions to an approved emotional support animal.",
    icon: "/california-benefits-workplaceconsideration.svg",
  },
];
...
const emotionalBenefits = [
  {
    ...
    description:
      "For many people in Maryland, an emotional support animal can ease anxious thoughts and significantly bring relief to stress-inducing thoughts and feelings.",
    icon: "/whomayqualifies-panicattack.svg",
  },
  {
    title: "Promotes Emotional Stability",
    description:
      "Consistent companionship from an ESA may offer reassurance and comfort, helping individuals maintain steadier emotional well-being over time.",
    icon: "/california-benefits-strongersense.svg",
  },
  {
    title: "Encourages Routine and Purpose",
    description:
      "Caring for an animal could generate a sense of responsibility, a stronger feeling of purpose, and a connection in everyday life.",
    icon: "/california-benefits-strongersense.svg",
  },
];
...
export function MarylandBenefitsSection() {
  return (
          ...
          <div className="order-1 lg:order-2 lg:col-span-5 relative flex justify-end items-stretch w-full">
            ...
            <div className="sm:hidden relative w-full aspect-[390/513]">
              <Image
                ...
                alt="Benefits of Having an ESA Letter in Maryland Mobile View"
                fill
                priority
                unoptimized
            ...
            <div className="hidden sm:block lg:hidden relative w-full aspect-[834/1050]">
              <Image
                ...
                alt="Benefits of Having an ESA Letter in Maryland Tablet View"
                fill
                priority
                unoptimized
                className="object-cover object-top"
            ...
            <div className="hidden lg:block relative w-full h-full lg:min-h-0 flex items-stretch">
              <Image
                ...
                alt="Benefits of Having an ESA Letter in Maryland"
                fill
                priority
                unoptimized
          ...
          <div className="order-2 lg:order-1 lg:col-span-7 px-4 sm:px-6 lg:px-0 py-2 sm:py-4 lg:py-5 xl:py-12 pr-0 lg:pr-3 xl:pr-4 flex flex-col justify-center">
            ...
            <div className="mb-4 lg:mb-5 xl:mb-8">
              ...
              <p className="font-sans text-xs sm:text-sm lg:text-[12px] xl:text-base text-[#5F6B6F] font-medium leading-relaxed max-w-[520px]">
                Learn how obtaining a valid ESA letter Maryland can confirm your disability-related need for emotional support while also simplifying housing approval processes, promoting reassurance, and safeguarding your ability to reside comfortably with your companion animal.
              </p>
            </div>

...
const steps = [
  {
    ...
    description:
      "Start by selecting a convenient time to get in touch with a licensed mental health professional authorized in Maryland.",
  ...
  },
  {
    ...
    description:
      "After scheduling, you’ll attend a phone or video session with the clinician. During this consultation, they review your mental health background, current symptoms, and therapeutic needs to determine whether an emotional support animal would provide a meaningful benefit.",
  ...
  },
  {
    ...
    description:
      "Post the evaluation is completed, the mental health professional will reach an independent, non-biased decision based on the information collected. If the ESA is considered necessary, the letter is issued and sent via email.",
...
export function MarylandProcessSection() {
  const scrollToForm = () => {
    ...
    >
      <div className="max-w-[1260px] mx-auto">
        ...
        <div className="text-center max-w-[1050px] mx-auto mb-14 sm:mb-16">
          <h2 className="font-heading text-2xl sm:text-3xl lg:text-[40px] xl:text-[44px] font-bold text-[#1E3E47] leading-[1.18] tracking-tight mb-4 md:whitespace-nowrap"> How ESA Evaluation Process Works in Maryland? </h2>
          <p className="font-sans text-sm sm:text-base lg:text-[16.5px] text-[#5F6B6F] font-medium leading-[1.65]">
            People residing in Maryland can get individualized mental and emotional health assessments conducted by licensed Maryland professionals in these 3 quick steps!
          </p>
        </div>
        ...
        <div className="bg-[#FAF5EB] rounded-[32px] sm:rounded-[36px] border border-[#EFE8DC] p-8 sm:p-10 lg:p-12 max-w-[920px] mx-auto shadow-xs">
          <h3 className="font-heading text-2xl sm:text-3xl font-bold text-[#1E3E47] text-center mb-8">
            Our Unique Approach to ESA Letter in Maryland
          </h3>

...
const esaBullets = [
  ...
  "No specialized task training required; valid ESA letter needed from a Maryland clinician.",
...
export function MarylandPsdVsEsaSection() {
  return (
      ...
      <div className="max-w-[1080px] mx-auto">
        ...
        <div className="text-center max-w-[840px] mx-auto mb-10 sm:mb-12 lg:mb-14">
          <h2 className="font-heading text-2xl sm:text-3xl lg:text-[38px] xl:text-[42px] font-bold text-[#1E3E47] leading-[1.2] tracking-tight">
            ...
            <br className="hidden sm:inline" /> Support Animals in Maryland
          </h2>
          <p className="font-sans text-xs sm:text-sm lg:text-[15px] text-[#5F6B6F] font-medium leading-relaxed mt-3 max-w-[760px] mx-auto">
            In Maryland, it&apos;s important to understand the distinction between Psychiatric Service Dogs (PSDs) and Emotional Support Animals (ESAs). Each category has unique requirements and distinct legal protections.
          </p>
        </div>

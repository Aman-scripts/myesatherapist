...
const fedBullets = [
  {
    title: "Fair Housing Act (FHA) Rights",
    text: "Qualified individuals in Missouri with a disability-related need for an ESA are entitled to request housing accommodation adjustments.",
  },
  {
    title: "Exemption From Pet-Related Charges",
    text: "Landlords in Missouri are prohibited from charging pet rent or deposits for ESAs since they are not classified as pets under housing law.",
  },
  {
    title: "Individualized Accommodation Review",
    text: "Housing providers must evaluate ESA requests individually without automatically applying pet breed, size, or weight limits.",
  }
];
...
const provBullets = [
  {
    ...
    text: "Landlords can confirm that ESA letters were provided by a registered mental health practitioner and meet standard requirements.",
  },
  {
    title: "Respecting Medical Privacy Rights",
    text: "Landlords cannot demand disclosure of specific diagnoses or comprehensive medical records to evaluate an accommodation.",
  },
  {
    title: "Safety and Property Considerations",
    text: "Housing providers may deny an ESA request only if reliable evidence shows the specific animal poses a direct risk or physical damage.",
  }
];

export function MissouriLawsSection() {
  return (
      ...
      <div className="max-w-[1060px] mx-auto">
        ...
        <div className="text-center max-w-[820px] mx-auto mb-8 sm:mb-10 lg:mb-12">
          <h2 className="font-heading text-2xl sm:text-3xl lg:text-[36px] xl:text-[40px] font-bold text-[#1E3E47] leading-[1.2] tracking-tight mb-3">
            Housing Accommodations For Emotional Support Animals in Missouri
          </h2>
          <p className="font-sans text-xs sm:text-sm lg:text-[14.5px] text-[#5F6B6F] font-medium leading-relaxed max-w-[760px] mx-auto">
            In Missouri, requests for accommodations for emotional support animals are reviewed in accordance with federal housing laws and Fair Housing Act guidelines.
          </p>
        </div>

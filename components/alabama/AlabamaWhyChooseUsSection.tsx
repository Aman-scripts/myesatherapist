...
const features = [
  ...
  },
  {
    ...
    description:
      "When clinically appropriate, ESA letters are issued in compliance with applicable federal and Alabama state housing guidelines.",
  },
  {
...
export function AlabamaWhyChooseUsSection() {
  return (

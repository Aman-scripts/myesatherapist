...
const stateCities = [{'name': 'Omaha', 'icon': '/losangeles.svg'}, {'name': 'Lincoln', 'icon': '/sanfrancisco.svg'}, {'name': 'Bellevue', 'icon': '/losangelestwo.svg'}, {'name': 'Grand Island', 'icon': '/losangelesfour.svg'}, {'name': 'Kearney', 'icon': '/losangelesthree.svg'}, {'name': 'Fremont', 'icon': '/sanfranciscotwo.svg'}, {'name': 'Hastings', 'icon': '/sanfranciscothree.svg'}, {'name': 'Norfolk', 'icon': '/sanfranciscofour.svg'}];

export function NebraskaAvailableCitiesSection() {
  return (
      ...
      <div className="max-w-[1060px] mx-auto">
        ...
        <div className="text-center max-w-[840px] mx-auto mb-10 sm:mb-12 lg:mb-14">
          <h2 className="font-heading text-2xl sm:text-3xl lg:text-[40px] xl:text-[44px] font-bold text-[#1E3E47] leading-[1.2] tracking-tight">
            Available Everywhere in Nebraska
          </h2>
          <p className="font-sans text-xs sm:text-sm lg:text-[15px] text-[#5F6B6F] font-medium leading-relaxed mt-3 max-w-[760px] mx-auto">
            ...
            across all cities and counties in Nebraska.
          </p>
        </div>

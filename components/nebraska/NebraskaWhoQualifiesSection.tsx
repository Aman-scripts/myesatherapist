...
const conditions = [
  {
    ...
    description: "Persistent nervousness and anxiety affecting daily routine.",
    icon: "/whomayqualifies-california_chronicworry.svg",
  },
  {
    title: "Major Depressive Disorder",
    description: "Persistent low mood impacting daily activities and energy.",
    icon: "/whomayqualifies-panicattack.svg",
  },
  {
    title: "Adjustment Disorder",
    description: "Difficulty coping with major life changes or stressors.",
    icon: "/whomayqualifies-california_posttrauma.svg",
  },
  {
    title: "Social Anxiety Disorder",
    description: "Intense fear of social interaction and public spaces.",
    icon: "/whomayqualifies-moodconditions.svg",
  }
];

export function NebraskaWhoQualifiesSection() {
  return (
          ...
          <div className="order-1 lg:order-2 lg:col-span-5 relative flex justify-end items-center w-full">
            <div className="sm:hidden relative w-full aspect-[390/440]">
              <Image
                ...
                alt="Who May Qualify for an ESA Letter in Nebraska Mobile View"
                fill
                priority
                unoptimized
            ...
            <div className="hidden sm:block lg:hidden relative w-full aspect-[834/943]">
              <Image
                ...
                alt="Who May Qualify for an ESA Letter in Nebraska Tablet View"
                fill
                priority
                unoptimized
                className="object-cover object-top"
            ...
            <div className="hidden lg:flex items-center justify-end w-full h-full">
              <div className="relative w-full max-h-[620px] aspect-[694/827] ml-auto">
                <Image
                  ...
                  alt="Who qualifies for Nebraska ESA Letter"
                  fill
                  priority
                  unoptimized

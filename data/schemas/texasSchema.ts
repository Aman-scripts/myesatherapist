export const texasSchema = {
  ...
  "@graph": [
    ...
    {
      "@type": "Place",
      "@id": "https://myesatherapist.com/esa-letter-texas/#place",
      "name": "Texas",
      "address": {
        "@type": "PostalAddress",
        "addressRegion": "TX",
    ...
    {
      "@type": "WebPage",
      "@id": "https://myesatherapist.com/esa-letter-texas/#webpage",
      "url": "https://myesatherapist.com/esa-letter-texas/",
      "name": "Texas ESA Letter Evaluations by Licensed Therapists - My ESA Therapist",
      "description": "Get evaluated for texas ESA letter by licensed therapists. Secure online assessments with compliant housing documentation.",
      "isPartOf": {
        "@id": "https://myesatherapist.com/#website"
      },
      "about": {
        "@id": "https://myesatherapist.com/esa-letter-texas/#service"
      },
      "mainEntity": {
        "@id": "https://myesatherapist.com/esa-letter-texas/#service"
      },
      "primaryImageOfPage": {
        "@id": "https://myesatherapist.com/esa-letter-texas/#primaryimage"
      },
      "image": {
        "@id": "https://myesatherapist.com/esa-letter-texas/#primaryimage"
      },
      "breadcrumb": {
        "@id": "https://myesatherapist.com/esa-letter-texas/#breadcrumb"
      },
      "publisher": {
        "@id": "https://myesatherapist.com/#organization"
      },
    ...
    },
    {
      "@type": "ImageObject",
      "@id": "https://myesatherapist.com/esa-letter-texas/#primaryimage",
      "url": "https://myesatherapist.com/images/states/texas-esa-letter-sample.webp",
      "contentUrl": "https://myesatherapist.com/images/states/texas-esa-letter-sample.webp",
      "caption": "ESA Letter Online Evaluations for Texas Residents"
    },
    {
      "@type": "BreadcrumbList",
      "@id": "https://myesatherapist.com/esa-letter-texas/#breadcrumb",
      "itemListElement": [
        ...
        },
        {
          ...
          "item": "https://myesatherapist.com/esa-letter-texas/"
        }
      ]
    },
    {
      "@type": "Service",
      "@id": "https://myesatherapist.com/esa-letter-texas/#service",
      "name": "Texas ESA Letter Evaluation",
      "description": "Online Emotional Support Animal evaluations by licensed mental health professionals for Texas residents, delivered entirely via telehealth. ESA letters are issued only when clinically appropriate after an independent mental health assessment aligned with Fair Housing Act (FHA) guidelines.",
      "url": "https://myesatherapist.com/esa-letter-texas/",
      ...
      "audience": {
        "@type": "Audience",
        "@id": "https://myesatherapist.com/esa-letter-texas/#audience",
        "audienceType": "Adults in Texas seeking Emotional Support Animal evaluations"
      },
      "availableChannel": {
        "@type": "ServiceChannel",
        "serviceUrl": "https://myesatherapist.com/esa-letter-texas/",
      ...
      "offers": {
        "@id": "https://myesatherapist.com/esa-letter-texas/#offer"
      },
      "hasOfferCatalog": {
        "@type": "OfferCatalog",
        "name": "ESA Letter Services - Texas",
        "itemListElement": [
          {
            "@type": "Offer",
            "itemOffered": {
    ...
    {
      "@type": "FAQPage",
      "@id": "https://myesatherapist.com/esa-letter-texas/#faq",
      "mainEntity": [
        {
          "@type": "Question",
          "name": "What questions are asked during an ESA evaluation in Texas?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "During an online ESA evaluation for Texas residents, clinicians typically ask about your mental health history, current symptoms, daily functioning, housing situation, and how an animal may provide emotional support. Questions focus on clinical need, not pet ownership preferences."
          }
        },
        {
          "@type": "Question",
          "name": "How Much Does an ESA Letter Cost in Texas?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "The cost of an ESA letter for Texas residents varies by provider and evaluation method. Typically, it ranges around $100\u2013$200 for a proper assessment by a licensed professional. At My ESA Therapist, the fee is $149, which includes the online evaluation and issuance of the ESA letter if you qualify."
          }
        },
        {
          "@type": "Question",
          "name": "Can any doctor write an ESA letter for Texas residents?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "No, not every doctor can write an ESA letter. The letter must be issued by a licensed healthcare professional authorized to assess mental health and establish a therapeutic relationship remotely, such as a licensed therapist, psychologist, psychiatrist, or other qualified healthcare professional authorized to practice telehealth for Texas residents."
          }
        },
        {
          "@type": "Question",
          "name": "Can working professionals in Texas qualify for an emotional support animal?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Yes, working professionals in Texas may qualify for an ESA if they have a mental health condition that affects daily functioning. Employment status does not impact eligibility, as ESA evaluations are based on clinical need, not occupation or income."
          }
        },
        {
          "@type": "Question",
          "name": "Is a single online ESA appointment enough for Texas residents?",
          "acceptedAnswer": {
            "@type": "Answer",
    ...
    {
      "@type": "VideoObject",
      "@id": "https://myesatherapist.com/esa-letter-texas/#video-1",
      "name": "ESA Letter Texas - Client Testimonial 1",
      "description": "Client testimonial video shared by My ESA Therapist about the Texas online ESA letter evaluation experience.",
      "thumbnailUrl": [
    ...
    {
      "@type": "VideoObject",
      "@id": "https://myesatherapist.com/esa-letter-texas/#video-2",
      "name": "ESA Letter Texas - Client Testimonial 2",
      "description": "Client testimonial video shared by My ESA Therapist about the Texas online ESA letter evaluation experience.",
      "thumbnailUrl": [
    ...
    {
      "@type": "VideoObject",
      "@id": "https://myesatherapist.com/esa-letter-texas/#video-3",
      "name": "ESA Letter Texas - Client Testimonial 3",
      "description": "Client testimonial video shared by My ESA Therapist about the Texas online ESA letter evaluation experience.",
      "thumbnailUrl": [
    ...
    {
      "@type": "VideoObject",
      "@id": "https://myesatherapist.com/esa-letter-texas/#video-4",
      "name": "ESA Letter Texas - Client Testimonial 4",
      "description": "Client testimonial video shared by My ESA Therapist about the Texas online ESA letter evaluation experience.",
      "thumbnailUrl": [
    ...
    {
      "@type": "VideoObject",
      "@id": "https://myesatherapist.com/esa-letter-texas/#video-5",
      "name": "ESA Letter Texas - Client Testimonial 5",
      "description": "Client testimonial video shared by My ESA Therapist about the Texas online ESA letter evaluation experience.",
      "thumbnailUrl": [
    ...
    {
      "@type": "VideoObject",
      "@id": "https://myesatherapist.com/esa-letter-texas/#video-6",
      "name": "ESA Letter Texas - Client Testimonial 6",
      "description": "Client testimonial video shared by My ESA Therapist about the Texas online ESA letter evaluation experience.",
      "thumbnailUrl": [
    ...
    {
      "@type": "VideoObject",
      "@id": "https://myesatherapist.com/esa-letter-texas/#video-7",
      "name": "ESA Letter Texas - Client Testimonial 7",
      "description": "Client testimonial video shared by My ESA Therapist about the Texas online ESA letter evaluation experience.",
      "thumbnailUrl": [

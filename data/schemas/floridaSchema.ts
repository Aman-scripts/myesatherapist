export const floridaSchema = {
  ...
  "@graph": [
    ...
    {
      "@type": "Place",
      "@id": "https://myesatherapist.com/esa-letter-florida/#place",
      "name": "Florida",
      "address": {
        "@type": "PostalAddress",
        "addressRegion": "FL",
    ...
    },
    {
      ...
      "about": {
        "@id": "https://myesatherapist.com/esa-letter-florida/#service",
      },
      "mainEntity": {
        "@id": "https://myesatherapist.com/esa-letter-florida/#service",
      },
      "primaryImageOfPage": {
        "@id": "https://myesatherapist.com/esa-letter-florida/#primaryimage",
      },
      "image": {
        "@id": "https://myesatherapist.com/esa-letter-florida/#primaryimage",
      },
      "breadcrumb": {
        "@id": "https://myesatherapist.com/esa-letter-florida/#breadcrumb",
      },
      "publisher": {
        "@id": "https://myesatherapist.com/#organization",
      },
    ...
    },
    {
      "@type": "ImageObject",
      "@id": "https://myesatherapist.com/esa-letter-florida/#primaryimage",
      "url": "https://myesatherapist.com/images/states/florida-esa-letter-sample.webp",
      "contentUrl": "https://myesatherapist.com/images/states/florida-esa-letter-sample.webp",
      "caption": "ESA Letter Online Evaluations for Florida Residents",
    },
    {
      "@type": "BreadcrumbList",
      "@id": "https://myesatherapist.com/esa-letter-florida/#breadcrumb",
      "itemListElement": [
        ...
        },
        {
          ...
          "item": "https://myesatherapist.com/esa-letter-florida/",
        },
      ],
    },
    {
      "@type": "Service",
      "@id": "https://myesatherapist.com/esa-letter-florida/#service",
      "name": "Florida ESA Letter Evaluation",
      "description": "Online Emotional Support Animal evaluations by licensed mental health professionals for Florida residents, delivered entirely via telehealth. ESA letters are issued only when clinically appropriate after an independent mental health assessment aligned with Fair Housing Act (FHA) guidelines.",
      "url": "https://myesatherapist.com/esa-letter-florida/",
      ...
      "audience": {
        "@type": "Audience",
        "@id": "https://myesatherapist.com/esa-letter-florida/#audience",
        "audienceType": "Adults in Florida seeking Emotional Support Animal evaluations",
      },
      "availableChannel": {
        "@type": "ServiceChannel",
        "serviceUrl": "https://myesatherapist.com/esa-letter-florida/",
      ...
      "offers": {
        "@id": "https://myesatherapist.com/esa-letter-florida/#offer",
      },
      "hasOfferCatalog": {
        "@type": "OfferCatalog",
        "name": "ESA Letter Services - Florida",
        "itemListElement": [
          {
            "@type": "Offer",
            "itemOffered": {
    ...
    {
      "@type": "FAQPage",
      "@id": "https://myesatherapist.com/esa-letter-florida/#faq",
      "mainEntity": [
        {
          "@type": "Question",
          "name": "What questions are asked during an ESA evaluation in Florida?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "During an online ESA evaluation for Florida residents, clinicians typically ask about your mental health history, current symptoms, daily functioning, housing situation, and how an animal may provide emotional support. Questions focus on clinical need, not pet ownership preferences.",
          },
        },
        {
          "@type": "Question",
          "name": "How Much Does an ESA Letter Cost in Florida?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "The cost of an ESA letter for Florida residents varies by provider and evaluation method. Typically, it ranges around $100–$200 for a proper assessment by a licensed professional. At My ESA Therapist, the fee is $149, which includes the online evaluation and issuance of the ESA letter if you qualify.",
          },
        },
        {
          "@type": "Question",
          "name": "Can any doctor write an ESA letter for Florida residents?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "No, not every doctor can write an ESA letter. The letter must be issued by a licensed healthcare professional authorized to assess mental health and establish a therapeutic relationship remotely, such as a licensed therapist, psychologist, psychiatrist, or other qualified healthcare professional authorized to practice telehealth for Florida residents.",
          },
        },
        {
          "@type": "Question",
          "name": "Can working professionals in Florida qualify for an emotional support animal?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Yes, working professionals in Florida may qualify for an ESA if they have a mental health condition that affects daily functioning. Employment status does not impact eligibility, as ESA evaluations are based on clinical need, not occupation or income.",
          },
        },
        {
          "@type": "Question",
          "name": "Is a single online ESA appointment enough for Florida residents?",
          "acceptedAnswer": {
            "@type": "Answer",
    ...
    {
      "@type": "VideoObject",
      "@id": "https://myesatherapist.com/esa-letter-florida/#video-1",
      "name": "ESA Letter Florida - Client Testimonial 1",
      "description": "Client testimonial video shared by My ESA Therapist about the Florida online ESA letter evaluation experience.",
      "thumbnailUrl": [
    ...
    {
      "@type": "VideoObject",
      "@id": "https://myesatherapist.com/esa-letter-florida/#video-2",
      "name": "ESA Letter Florida - Client Testimonial 2",
      "description": "Client testimonial video shared by My ESA Therapist about the Florida online ESA letter evaluation experience.",
      "thumbnailUrl": [
    ...
    {
      "@type": "VideoObject",
      "@id": "https://myesatherapist.com/esa-letter-florida/#video-3",
      "name": "ESA Letter Florida - Client Testimonial 3",
      "description": "Client testimonial video shared by My ESA Therapist about the Florida online ESA letter evaluation experience.",
      "thumbnailUrl": [
    ...
    {
      "@type": "VideoObject",
      "@id": "https://myesatherapist.com/esa-letter-florida/#video-4",
      "name": "ESA Letter Florida - Client Testimonial 4",
      "description": "Client testimonial video shared by My ESA Therapist about the Florida online ESA letter evaluation experience.",
      "thumbnailUrl": [
    ...
    {
      "@type": "VideoObject",
      "@id": "https://myesatherapist.com/esa-letter-florida/#video-5",
      "name": "ESA Letter Florida - Client Testimonial 5",
      "description": "Client testimonial video shared by My ESA Therapist about the Florida online ESA letter evaluation experience.",
      "thumbnailUrl": [
    ...
    {
      "@type": "VideoObject",
      "@id": "https://myesatherapist.com/esa-letter-florida/#video-6",
      "name": "ESA Letter Florida - Client Testimonial 6",
      "description": "Client testimonial video shared by My ESA Therapist about the Florida online ESA letter evaluation experience.",
      "thumbnailUrl": [
    ...
    {
      "@type": "VideoObject",
      "@id": "https://myesatherapist.com/esa-letter-florida/#video-7",
      "name": "ESA Letter Florida - Client Testimonial 7",
      "description": "Client testimonial video shared by My ESA Therapist about the Florida online ESA letter evaluation experience.",
      "thumbnailUrl": [

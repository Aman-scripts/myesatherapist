export const utahSchema = {
  ...
  "@graph": [
    ...
    {
      "@type": "Place",
      "@id": "https://myesatherapist.com/esa-letter-utah/#place",
      "name": "Utah",
      "address": {
        "@type": "PostalAddress",
        "addressRegion": "UT",
    ...
    {
      "@type": "WebPage",
      "@id": "https://myesatherapist.com/esa-letter-utah/#webpage",
      "url": "https://myesatherapist.com/esa-letter-utah/",
      "name": "Utah ESA Letter From Licensed Therapist | My ESA Therapist",
      "description": "Looking for an ESA letter in Utah? My ESA Therapist helps you connect with licensed mental health professionals for online esa letter evaluation in Utah.",
      "isPartOf": {
        "@id": "https://myesatherapist.com/#website"
      },
      "about": {
        "@id": "https://myesatherapist.com/esa-letter-utah/#service"
      },
      "mainEntity": {
        "@id": "https://myesatherapist.com/esa-letter-utah/#service"
      },
      "primaryImageOfPage": {
        "@id": "https://myesatherapist.com/esa-letter-utah/#primaryimage"
      },
      "image": {
        "@id": "https://myesatherapist.com/esa-letter-utah/#primaryimage"
      },
      "breadcrumb": {
        "@id": "https://myesatherapist.com/esa-letter-utah/#breadcrumb"
      },
      "publisher": {
        "@id": "https://myesatherapist.com/#organization"
      },
    ...
    },
    {
      "@type": "ImageObject",
      "@id": "https://myesatherapist.com/esa-letter-utah/#primaryimage",
      "url": "https://myesatherapist.com/images/states/utah-esa-letter-sample.webp",
      "contentUrl": "https://myesatherapist.com/images/states/utah-esa-letter-sample.webp",
      "caption": "ESA Letter Online Evaluations for Utah Residents"
    },
    {
      "@type": "BreadcrumbList",
      "@id": "https://myesatherapist.com/esa-letter-utah/#breadcrumb",
      "itemListElement": [
        ...
        },
        {
          ...
          "item": "https://myesatherapist.com/esa-letter-utah/"
        }
      ]
    },
    {
      "@type": "Service",
      "@id": "https://myesatherapist.com/esa-letter-utah/#service",
      "name": "Utah ESA Letter Evaluation",
      "description": "Online Emotional Support Animal evaluations by licensed mental health professionals for Utah residents, delivered entirely via telehealth. ESA letters are issued only when clinically appropriate after an independent mental health assessment aligned with Fair Housing Act (FHA) guidelines.",
      "url": "https://myesatherapist.com/esa-letter-utah/",
      ...
      "audience": {
        "@type": "Audience",
        "@id": "https://myesatherapist.com/esa-letter-utah/#audience",
        "audienceType": "Adults in Utah seeking Emotional Support Animal evaluations"
      },
      "availableChannel": {
        "@type": "ServiceChannel",
        "serviceUrl": "https://myesatherapist.com/esa-letter-utah/",
      ...
      "offers": {
        "@id": "https://myesatherapist.com/esa-letter-utah/#offer"
      },
      "hasOfferCatalog": {
        "@type": "OfferCatalog",
        "name": "ESA Letter Services - Utah",
        "itemListElement": [
          {
            "@type": "Offer",
            "itemOffered": {
    ...
    {
      "@type": "FAQPage",
      "@id": "https://myesatherapist.com/esa-letter-utah/#faq",
      "mainEntity": [
        {
          "@type": "Question",
          "name": "What questions are asked during an ESA evaluation in Utah?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "During an online ESA evaluation for Utah residents, clinicians typically ask about your mental health history, current symptoms, daily functioning, housing situation, and how an animal may provide emotional support. Questions focus on clinical need, not pet ownership preferences."
          }
        },
        {
          "@type": "Question",
          "name": "How Much Does an ESA Letter Cost in Utah?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "The cost of an ESA letter for Utah residents varies by provider and evaluation method. Typically, it ranges around $100\u2013$200 for a proper assessment by a licensed professional. At My ESA Therapist, the fee is $149, which includes the online evaluation and issuance of the ESA letter if you qualify."
          }
        },
        {
          "@type": "Question",
          "name": "Can any doctor write an ESA letter for Utah residents?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "No, not every doctor can write an ESA letter. The letter must be issued by a licensed healthcare professional authorized to assess mental health and establish a therapeutic relationship remotely, such as a licensed therapist, psychologist, psychiatrist, or other qualified healthcare professional authorized to practice telehealth for Utah residents."
          }
        },
        {
          "@type": "Question",
          "name": "Can working professionals in Utah qualify for an emotional support animal?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Yes, working professionals in Utah may qualify for an ESA if they have a mental health condition that affects daily functioning. Employment status does not impact eligibility, as ESA evaluations are based on clinical need, not occupation or income."
          }
        },
        {
          "@type": "Question",
          "name": "Is a single online ESA appointment enough for Utah residents?",
          "acceptedAnswer": {
            "@type": "Answer",
        ...
        {
          "@type": "Question",
          "name": "Does a condition need to be severe to qualify for an ESA in Utah?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "No, a condition does not need to be severe to qualify for an ESA in Utah. Eligibility is based on whether a mental health condition substantially affects daily functioning and whether an emotional support animal is clinically appropriate, as determined through a licensed professional's online evaluation."
          }
        }
      ]
    },
    {
      "@type": "VideoObject",
      "@id": "https://myesatherapist.com/esa-letter-utah/#video-1",
      "name": "ESA Letter Utah - Client Testimonial 1",
      "description": "Client testimonial video shared by My ESA Therapist about the Utah online ESA letter evaluation experience.",
      "thumbnailUrl": [
    ...
    {
      "@type": "VideoObject",
      "@id": "https://myesatherapist.com/esa-letter-utah/#video-2",
      "name": "ESA Letter Utah - Client Testimonial 2",
      "description": "Client testimonial video shared by My ESA Therapist about the Utah online ESA letter evaluation experience.",
      "thumbnailUrl": [
    ...
    {
      "@type": "VideoObject",
      "@id": "https://myesatherapist.com/esa-letter-utah/#video-3",
      "name": "ESA Letter Utah - Client Testimonial 3",
      "description": "Client testimonial video shared by My ESA Therapist about the Utah online ESA letter evaluation experience.",
      "thumbnailUrl": [
    ...
    {
      "@type": "VideoObject",
      "@id": "https://myesatherapist.com/esa-letter-utah/#video-4",
      "name": "ESA Letter Utah - Client Testimonial 4",
      "description": "Client testimonial video shared by My ESA Therapist about the Utah online ESA letter evaluation experience.",
      "thumbnailUrl": [
    ...
    {
      "@type": "VideoObject",
      "@id": "https://myesatherapist.com/esa-letter-utah/#video-5",
      "name": "ESA Letter Utah - Client Testimonial 5",
      "description": "Client testimonial video shared by My ESA Therapist about the Utah online ESA letter evaluation experience.",
      "thumbnailUrl": [
    ...
    {
      "@type": "VideoObject",
      "@id": "https://myesatherapist.com/esa-letter-utah/#video-6",
      "name": "ESA Letter Utah - Client Testimonial 6",
      "description": "Client testimonial video shared by My ESA Therapist about the Utah online ESA letter evaluation experience.",
      "thumbnailUrl": [
    ...
    {
      "@type": "VideoObject",
      "@id": "https://myesatherapist.com/esa-letter-utah/#video-7",
      "name": "ESA Letter Utah - Client Testimonial 7",
      "description": "Client testimonial video shared by My ESA Therapist about the Utah online ESA letter evaluation experience.",
      "thumbnailUrl": [

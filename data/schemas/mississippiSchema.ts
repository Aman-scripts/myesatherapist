export const mississippiSchema = {
  ...
  "@graph": [
    ...
    {
      "@type": "Place",
      "@id": "https://myesatherapist.com/esa-letter-mississippi/#place",
      "name": "Mississippi",
      "address": {
        "@type": "PostalAddress",
        "addressRegion": "MS",
    ...
    },
    {
      ...
      "about": {
        "@id": "https://myesatherapist.com/esa-letter-mississippi/#service"
      },
      "mainEntity": {
        "@id": "https://myesatherapist.com/esa-letter-mississippi/#service"
      },
      "primaryImageOfPage": {
        "@id": "https://myesatherapist.com/esa-letter-mississippi/#primaryimage"
      },
      "image": {
        "@id": "https://myesatherapist.com/esa-letter-mississippi/#primaryimage"
      },
      "breadcrumb": {
        "@id": "https://myesatherapist.com/esa-letter-mississippi/#breadcrumb"
      },
      "publisher": {
        "@id": "https://myesatherapist.com/#organization"
      },
    ...
    },
    {
      "@type": "ImageObject",
      "@id": "https://myesatherapist.com/esa-letter-mississippi/#primaryimage",
      "url": "https://myesatherapist.com/images/states/mississippi-esa-letter-sample.webp",
      "contentUrl": "https://myesatherapist.com/images/states/mississippi-esa-letter-sample.webp",
      "caption": "ESA Letter Online Evaluations for Mississippi Residents"
    },
    {
      "@type": "BreadcrumbList",
      "@id": "https://myesatherapist.com/esa-letter-mississippi/#breadcrumb",
      "itemListElement": [
        ...
        },
        {
          ...
          "item": "https://myesatherapist.com/esa-letter-mississippi/"
        }
      ]
    },
    {
      "@type": "Service",
      "@id": "https://myesatherapist.com/esa-letter-mississippi/#service",
      "name": "Mississippi ESA Letter Evaluation",
      "description": "Online Emotional Support Animal evaluations by licensed mental health professionals for Mississippi residents, delivered entirely via telehealth. ESA letters are issued only when clinically appropriate after an independent mental health assessment aligned with Fair Housing Act (FHA) guidelines.",
      "url": "https://myesatherapist.com/esa-letter-mississippi/",
      ...
      "audience": {
        "@type": "Audience",
        "@id": "https://myesatherapist.com/esa-letter-mississippi/#audience",
        "audienceType": "Adults in Mississippi seeking Emotional Support Animal evaluations"
      },
      "availableChannel": {
        "@type": "ServiceChannel",
        "serviceUrl": "https://myesatherapist.com/esa-letter-mississippi/",
      ...
      "offers": {
        "@id": "https://myesatherapist.com/esa-letter-mississippi/#offer"
      },
      "hasOfferCatalog": {
        "@type": "OfferCatalog",
        "name": "ESA Letter Services - Mississippi",
        "itemListElement": [
          {
            "@type": "Offer",
            "itemOffered": {
    ...
    {
      "@type": "FAQPage",
      "@id": "https://myesatherapist.com/esa-letter-mississippi/#faq",
      "mainEntity": [
        {
          "@type": "Question",
          "name": "What questions are asked during an ESA evaluation in Mississippi?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "During an online ESA evaluation for Mississippi residents, clinicians typically ask about your mental health history, current symptoms, daily functioning, housing situation, and how an animal may provide emotional support. Questions focus on clinical need, not pet ownership preferences."
          }
        },
        {
          "@type": "Question",
          "name": "How Much Does an ESA Letter Cost in Mississippi?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "The cost of an ESA letter for Mississippi residents varies by provider and evaluation method. Typically, it ranges around $100–$200 for a proper assessment by a licensed professional. At My ESA Therapist, the fee is $149, which includes the online evaluation and issuance of the ESA letter if you qualify."
          }
        },
        {
          "@type": "Question",
          "name": "Can any doctor write an ESA letter for Mississippi residents?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "No, not every doctor can write an ESA letter. The letter must be issued by a licensed healthcare professional authorized to assess mental health and establish a therapeutic relationship remotely, such as a licensed therapist, psychologist, psychiatrist, or other qualified healthcare professional authorized to practice telehealth for Mississippi residents."
          }
        },
        {
          "@type": "Question",
          "name": "Can working professionals in Mississippi qualify for an emotional support animal?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Yes, working professionals in Mississippi may qualify for an ESA if they have a mental health condition that affects daily functioning. Employment status does not impact eligibility, as ESA evaluations are based on clinical need, not occupation or income."
          }
        },
        {
          "@type": "Question",
          "name": "Is a single online ESA appointment enough for Mississippi residents?",
          "acceptedAnswer": {
            "@type": "Answer",
        ...
        {
          "@type": "Question",
          "name": "Does a condition need to be severe to qualify for an ESA in Mississippi?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "No, a condition does not need to be severe to qualify for an ESA in Mississippi. Eligibility is based on whether a mental health condition substantially affects daily functioning and whether an emotional support animal is clinically appropriate, as determined through a licensed professional's online evaluation."
          }
        }
      ]
    },
    {
      "@type": "VideoObject",
      "@id": "https://myesatherapist.com/esa-letter-mississippi/#video-1",
      "name": "ESA Letter Mississippi - Client Testimonial 1",
      "description": "Client testimonial video shared by My ESA Therapist about the Mississippi online ESA letter evaluation experience.",
      "thumbnailUrl": [
    ...
    {
      "@type": "VideoObject",
      "@id": "https://myesatherapist.com/esa-letter-mississippi/#video-2",
      "name": "ESA Letter Mississippi - Client Testimonial 2",
      "description": "Client testimonial video shared by My ESA Therapist about the Mississippi online ESA letter evaluation experience.",
      "thumbnailUrl": [
    ...
    {
      "@type": "VideoObject",
      "@id": "https://myesatherapist.com/esa-letter-mississippi/#video-3",
      "name": "ESA Letter Mississippi - Client Testimonial 3",
      "description": "Client testimonial video shared by My ESA Therapist about the Mississippi online ESA letter evaluation experience.",
      "thumbnailUrl": [
    ...
    {
      "@type": "VideoObject",
      "@id": "https://myesatherapist.com/esa-letter-mississippi/#video-4",
      "name": "ESA Letter Mississippi - Client Testimonial 4",
      "description": "Client testimonial video shared by My ESA Therapist about the Mississippi online ESA letter evaluation experience.",
      "thumbnailUrl": [
    ...
    {
      "@type": "VideoObject",
      "@id": "https://myesatherapist.com/esa-letter-mississippi/#video-5",
      "name": "ESA Letter Mississippi - Client Testimonial 5",
      "description": "Client testimonial video shared by My ESA Therapist about the Mississippi online ESA letter evaluation experience.",
      "thumbnailUrl": [
    ...
    {
      "@type": "VideoObject",
      "@id": "https://myesatherapist.com/esa-letter-mississippi/#video-6",
      "name": "ESA Letter Mississippi - Client Testimonial 6",
      "description": "Client testimonial video shared by My ESA Therapist about the Mississippi online ESA letter evaluation experience.",
      "thumbnailUrl": [
    ...
    {
      "@type": "VideoObject",
      "@id": "https://myesatherapist.com/esa-letter-mississippi/#video-7",
      "name": "ESA Letter Mississippi - Client Testimonial 7",
      "description": "Client testimonial video shared by My ESA Therapist about the Mississippi online ESA letter evaluation experience.",
      "thumbnailUrl": [

...
export const STATES_DATA: Record<string, StateData> = {
  ...
  utah: {
    ...
    cities: [
      { name: "Salt Lake City", icon: "/losangeles.svg" },
      { name: "West Valley City", icon: "/sanfrancisco.svg" },
      { name: "Provo", icon: "/losangelestwo.svg" },
      { name: "West Jordan", icon: "/losangelesfour.svg" },
      { name: "Orem", icon: "/losangelesthree.svg" },
      { name: "Sandy", icon: "/sanfranciscotwo.svg" },
      { name: "Ogden", icon: "/sanfranciscothree.svg" },
      { name: "St. George", icon: "/sanfranciscofour.svg" },
    ],
  },
  "south-carolina": {
    slug: "south-carolina",
    ...
    cities: [
      { name: "Charleston", icon: "/losangeles.svg" },
      { name: "Columbia", icon: "/sanfrancisco.svg" },
      { name: "North Charleston", icon: "/losangelestwo.svg" },
      { name: "Mount Pleasant", icon: "/losangelesfour.svg" },
      { name: "Rock Hill", icon: "/losangelesthree.svg" },
      { name: "Greenville", icon: "/sanfranciscotwo.svg" },
      { name: "Summerville", icon: "/sanfranciscothree.svg" },
      { name: "Goose Creek", icon: "/sanfranciscofour.svg" },
    ],
  },
  virginia: {
    slug: "virginia",
    ...
    cities: [
      { name: "Virginia Beach", icon: "/losangeles.svg" },
      { name: "Chesapeake", icon: "/sanfrancisco.svg" },
      { name: "Norfolk", icon: "/losangelestwo.svg" },
      { name: "Richmond", icon: "/losangelesfour.svg" },
      { name: "Newport News", icon: "/losangelesthree.svg" },
      { name: "Alexandria", icon: "/sanfranciscotwo.svg" },
      { name: "Hampton", icon: "/sanfranciscothree.svg" },
      { name: "Roanoke", icon: "/sanfranciscofour.svg" },
    ],
  },
  "west-virginia": {
    slug: "west-virginia",
    ...
    cities: [
      { name: "Charleston", icon: "/losangeles.svg" },
      { name: "Huntington", icon: "/sanfrancisco.svg" },
      { name: "Morgantown", icon: "/losangelestwo.svg" },
      { name: "Parkersburg", icon: "/losangelesfour.svg" },
      { name: "Wheeling", icon: "/losangelesthree.svg" },
      { name: "Martinsburg", icon: "/sanfranciscotwo.svg" },
      { name: "Weirton", icon: "/sanfranciscothree.svg" },
      { name: "Fairmont", icon: "/sanfranciscofour.svg" },
    ],
  },
};
